  ...
  return (
    <div className="mt-3 space-y-2">
      <button
        ...
        disabled={isPending}
        className="flex items-center gap-1.5 rounded-md border border-dashed border-gray-300 px-3 py-2 text-sm text-gray-500 hover:border-gray-400 hover:text-gray-700 disabled:opacity-50"
      >
        {isPending ? (
          <>

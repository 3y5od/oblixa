...
import { V10_READ_MODEL_FIELDS, V10_SHARED_READ_MODEL_FIELDS } from "./release-contract";
import {
...
function buildV10ReadModelRuntimeContract(
  ...
  return {
    key,
    tableName: `v10_${key}`,
    sourceArtifact: input.sourceArtifact ?? "src/lib/read-models.ts",
    refreshArtifact: input.refreshArtifact ?? "src/lib/read-model-refresh.ts",
...
export function validateV10ReadModelRuntimeContracts(
  ...
  for (const key of V10_REQUIRED_READ_MODEL_KEYS) {
    ...
    if (!row.refreshArtifact.includes("read-model-refresh")) failures.push(`${key}:refresh_artifact_required`);
...
export { assertV10SharedReadModelFields as assertSharedReadModelFields };
export { getV10ReadModelTableName as getReadModelTableName };
export { getV10VisibilityState as getVisibilityState };
export { queryV10ReadModel as queryReadModel };
export { V10_READ_MODEL_RUNTIME_CONTRACTS as READ_MODEL_RUNTIME_CONTRACTS };
export { V10_REQUIRED_READ_MODEL_KEYS as REQUIRED_READ_MODEL_KEYS };
export { V10_SOURCE_LINK_COLUMN_COMPATIBILITY as SOURCE_LINK_COLUMN_COMPATIBILITY };
export { validateV10ReadModelLineage as validateReadModelLineage };
export { validateV10ReadModelRuntimeContracts as validateReadModelRuntimeContracts };
export { validateV10SourceLinkColumnCompatibility as validateSourceLinkColumnCompatibility };
export type { V10ActivationStateReadModel as ActivationStateReadModel };
export type { V10AdvancedAssuranceLinkedRecordReadModel as AdvancedAssuranceLinkedRecordReadModel };
export type { V10ApprovalRecordReadModel as ApprovalRecordReadModel };
export type { V10AuditEventReadModel as AuditEventReadModel };
export type { V10CommandSearchIndexReadModel as CommandSearchIndexReadModel };
export type { V10ContractActivityEventReadModel as ContractActivityEventReadModel };
export type { V10ContractHealthSnapshotReadModel as ContractHealthSnapshotReadModel };
export type { V10EvidenceRequestStatusReadModel as EvidenceRequestStatusReadModel };
export type { V10ExceptionRecordReadModel as ExceptionRecordReadModel };
export type { V10ExternalEvidenceSubmissionReadModel as ExternalEvidenceSubmissionReadModel };
export type { V10FieldProvenanceRecordReadModel as FieldProvenanceRecordReadModel };
export type { V10JobRunVisibilityReadModel as JobRunVisibilityReadModel };
export type { V10NotificationDeliveryReadModel as NotificationDeliveryReadModel };
export type { V10ObligationRecordReadModel as ObligationRecordReadModel };
export type { V10ReadModel as ReadModel };
export type { V10ReadModelByKey as ReadModelByKey };
export type { V10ReadModelQueryContext as ReadModelQueryContext };
export type { V10ReadModelQueryMetadata as ReadModelQueryMetadata };
export type { V10ReadModelQueryOptions as ReadModelQueryOptions };
export type { V10ReadModelQueryResult as ReadModelQueryResult };
export type { V10ReadModelRuntimeContract as ReadModelRuntimeContract };
export type { V10RenewalCheckpointRecordReadModel as RenewalCheckpointRecordReadModel };
export type { V10RenewalPostureSnapshotReadModel as RenewalPostureSnapshotReadModel };
export type { V10ReportRunVisibilityReadModel as ReportRunVisibilityReadModel };
export type { V10SharedReadModelFields as SharedReadModelFields };
export type { V10SourceLinkColumnCompatibility as SourceLinkColumnCompatibility };
export type { V10WorkItemReadModel as WorkItemReadModel };

...
export const V10_ACCEPTANCE_MATRIX: readonly V10AcceptanceMatrixRow[] = [
  {
    ...
    artifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/v10-read-models.ts", "src/lib/v10-release-contract.ts"],
    gates: ["npm run check:migrations", "src/lib/v10-data-contracts.v10.test.ts"],
  },
  {
    id: "activation-intake",
    category: "surface",
    disposition: "shipped",
    artifacts: ["src/lib/v10-activation-state.ts", "src/app/api/import/contracts/route.ts", "src/app/(dashboard)/dashboard/page.tsx"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/app/api/import/contracts/route.test.ts"],
  },
  {
    id: "home-daily-brief",
    category: "surface",
    disposition: "shipped",
    artifacts: ["src/app/(dashboard)/dashboard/page.tsx", "src/lib/v10-ui-state-contracts.ts"],
    gates: ["src/lib/v10-ui-state-contracts.v10.test.ts", "npm run test:e2e:v10"],
  },
  {
    id: "unified-work",
    category: "surface",
    disposition: "shipped",
    artifacts: ["src/app/(dashboard)/work/page.tsx", "src/lib/v10-work-semantics.ts", "src/lib/work-hub-lens.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "npm run test:e2e:v10"],
  },
  {
    id: "contract-record",
    category: "surface",
  ...
  },
  {
    ...
    category: "data",
    disposition: "shipped",
    artifacts: ["src/lib/v10-field-provenance.ts", "src/actions/v4.ts"],
  ...
  },
  {
    ...
    category: "data",
    disposition: "shipped",
    artifacts: ["src/lib/v10-renewal-posture.ts", "src/actions/renewal-playbook.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts"],
  },
  {
    ...
    category: "operations",
    disposition: "shipped",
    artifacts: ["src/lib/v10-evidence-collaboration.ts", "src/app/api/cron/v4/evidence-followup/route.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/app/api/cron/v4/evidence-followup/route.test.ts"],
  },
  {
    id: "approvals-decisions-exceptions",
    category: "api",
    disposition: "shipped",
    artifacts: ["src/lib/v10-approval-exception.ts", "src/actions/approvals.ts", "src/actions/exceptions.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts"],
  },
  {
    ...
    gates: ["src/components/layout/command-palette.ui.test.tsx", "npm run test:e2e:v10"],
  },
  {
    id: "reports-exports-reviews",
    category: "api",
    disposition: "shipped",
    artifacts: ["src/lib/v10-report-export.ts", "src/lib/v10-read-model-refresh.ts", "src/app/api/export/contracts/route.ts", "src/app/api/reports/send-summaries/route.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/lib/v10-read-model-refresh.v10.test.ts"],
  },
  {
    id: "governance-health-reliability",
    category: "operations",
    disposition: "shipped",
    artifacts: ["src/lib/v10-governance.ts", "src/app/(dashboard)/settings/health/page.tsx", "src/actions/product-surface-settings.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/lib/v10-route-api-catalog.v10.test.ts", "src/actions/product-surface-settings.test.ts"],
  },
  {
    id: "telemetry-objectives",
    category: "measurement",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-objective-telemetry.ts", "src/lib/product-telemetry.ts", "src/lib/v10-readiness-scorecard.ts"],
    gates: ["src/lib/v10-objective-telemetry.v10.test.ts", "src/lib/product-telemetry.v10.test.ts", "npm run check:v10-release-evidence"],
  },
  {
    id: "accessibility-performance-responsive",
    category: "surface",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-ui-state-contracts.ts", "e2e/v10-core-smoke.spec.ts"],
    gates: ["src/lib/v10-ui-state-contracts.v10.test.ts", "npm run test:e2e:v10"],
  },
  {
    id: "p1-p2-continuity",
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-advanced-assurance-continuity.ts", "src/lib/v10-domain-depth-contracts.ts"],
    gates: ["src/lib/v10-continuity.v10.test.ts", "src/lib/v10-domain-depth-contracts.v10.test.ts"],
  },
  {
    id: "mutation-contracts",
    category: "api",
    disposition: "shipped",
    artifacts: ["src/lib/v10-mutation-envelope.ts", "src/actions/tasks.ts", "src/actions/approvals.ts", "src/actions/exceptions.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts"],
  },
  {
    ...
    category: "security",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-governance.ts", "supabase/migrations/057_v10_runtime_contracts.sql"],
    gates: ["src/lib/v10-hardening-contracts.v10.test.ts", "src/lib/v10-data-contracts.v10.test.ts"],
  },
  {
    id: "read-model-foundation",
    category: "data",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-read-models.ts", "src/lib/v10-read-model-refresh.ts"],
  ...
  },
  {
    ...
    category: "api",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-route-api-catalog.ts", "src/lib/v10-server-contracts.ts"],
    gates: ["src/lib/v10-route-api-catalog.v10.test.ts", "src/lib/v10-server-contracts.v10.test.ts"],
  },
  {
  ...
  },
  {
    ...
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-mutation-rollout.ts", "src/lib/v10-read-model-refresh.ts"],
    gates: ["src/lib/v10-mutation-rollout.v10.test.ts", "src/lib/v10-read-model-refresh.v10.test.ts"],
  },
  {
    id: "surface-component-primitives",
    category: "surface",
    disposition: "shipped",
    artifacts: ["src/lib/v10-ui-state-contracts.ts", "src/components/layout/command-palette.tsx"],
    gates: ["src/lib/v10-ui-state-contracts.v10.test.ts", "src/components/layout/command-palette.ui.test.tsx"],
  },
  {
    id: "negative-adversarial-coverage",
    category: "quality",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-mutation-envelope.ts"],
    gates: ["src/lib/v10-hardening-contracts.v10.test.ts", "src/lib/v10-semantics.v10.test.ts"],
  },
  {
    id: "acceptance-matrix",
    category: "release",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-acceptance-matrix.ts"],
  ...
  },
  {
    ...
    category: "quality",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-spec-trace-map.ts", "src/lib/v10-implementation-checklist.ts"],
    gates: ["npm run check:v10-suite"],
  },
  {
    id: "ci-quality-ratchets",
    category: "quality",
    disposition: "automated_gate",
    artifacts: ["scripts/check-v10-suite.mjs", "scripts/check-v10-release-evidence.mjs", "package.json"],
    gates: ["npm run check:v10-suite", "npm run check:v10-release-evidence"],
  },
  {
    id: "fixture-runbooks-observability",
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-release-evidence.ts", "src/lib/v10-objective-telemetry.ts"],
    gates: ["npm run check:v10-release-evidence"],
  ...
  },
  {
    ...
    category: "quality",
    disposition: "automated_gate",
    artifacts: ["src/lib/v9-release-contract.ts", "src/lib/v10-release-contract.ts"],
    gates: ["src/lib/v9-*.v9.test.ts", "src/lib/v10-release-contract.v10.test.ts"],
  },
  {
    id: "implementation-slicing",
    category: "quality",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-acceptance-matrix.ts", "scripts/check-v10-suite.mjs"],
    gates: ["src/lib/v10-acceptance-matrix.v10.test.ts", "npm run check:v10-suite"],
  },
  {
  ...
  },
  {
    ...
    category: "security",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-governance.ts", "src/lib/v10-hardening-contracts.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/lib/v10-hardening-contracts.v10.test.ts"],
  },
  {
  ...
  },
  {
    ...
    category: "release",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-implementation-checklist.ts", "src/lib/v10-release-contract.ts"],
    gates: ["src/lib/v10-implementation-checklist.v10.test.ts", "src/lib/v10-release-contract.v10.test.ts"],
  },
  {
    id: "risk-register-review",
    category: "release",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-release-evidence.ts", "src/lib/v10-hardening-contracts.ts"],
    gates: ["npm run check:v10-release-evidence"],
  },
  {
    ...
    category: "quality",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-spec-trace-map.ts", "src/lib/v10-acceptance-matrix.ts"],
    gates: ["src/lib/v10-data-contracts.v10.test.ts", "src/lib/v10-acceptance-matrix.v10.test.ts"],
  },
  {
  ...
  },
  {
    ...
    category: "release",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-release-evidence.ts", "src/lib/v10-acceptance-matrix.ts"],
    gates: ["src/lib/v10-acceptance-matrix.v10.test.ts"],
  },
  {
    ...
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-governance.ts", "src/lib/v10-release-evidence.ts"],
    gates: ["src/lib/v10-hardening-contracts.v10.test.ts", "src/lib/v10-release-evidence.v10.test.ts"],
  ...
  },
  {
    ...
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/lib/v10-route-api-catalog.v10.test.ts"],
  },
  {
    id: "audit-vocabulary-taxonomy",
    category: "api",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-status-action-vocabulary.ts", "src/lib/v10-release-contract.ts"],
    gates: ["src/lib/v10-status-action-vocabulary.v10.test.ts"],
  },
  {
    id: "seed-backfill-tooling",
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-read-model-refresh.ts", "src/lib/v10-release-evidence.ts"],
    gates: ["src/lib/v10-read-model-refresh.v10.test.ts", "npm run check:v10-release-evidence"],
  },
  {
    id: "journey-contracts",
    category: "surface",
    disposition: "automated_gate",
    artifacts: ["e2e/v10-core-smoke.spec.ts", "src/lib/v10-autonomous-coverage.ts"],
    gates: ["npm run test:e2e:v10", "src/lib/v10-autonomous-coverage.v10.test.ts"],
  },
  {
    id: "api-response-schemas",
    category: "api",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-mutation-envelope.ts", "src/lib/v10-route-api-catalog.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/lib/v10-route-api-catalog.v10.test.ts"],
  },
  {
    ...
    category: "security",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-evidence-collaboration.ts"],
    gates: ["src/lib/v10-hardening-contracts.v10.test.ts", "src/lib/v10-semantics.v10.test.ts"],
  },
  {
  ...
  },
  {
    ...
    category: "data",
    disposition: "automated_gate",
    artifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/v10-release-contract.ts"],
    gates: ["npm run check:migrations", "src/lib/v10-data-contracts.v10.test.ts"],
  },
  {
    ...
    category: "surface",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-ui-state-contracts.ts"],
    gates: ["src/lib/v10-hardening-contracts.v10.test.ts", "src/lib/v10-ui-state-contracts.v10.test.ts"],
  },
  {
    id: "browser-device-support",
    category: "surface",
    disposition: "automated_gate",
    artifacts: ["e2e/v10-core-smoke.spec.ts", "src/lib/v10-ui-state-contracts.ts"],
    gates: ["npm run test:e2e:v10"],
  },
  {
    id: "adoption-operational-feedback",
    category: "measurement",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-objective-telemetry.ts", "src/lib/v10-release-evidence.ts"],
    gates: ["npm run check:v10-release-evidence"],
    blockerType: "external_dashboard",
  },
  {
    ...
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-server-contracts.ts", "scripts/check-v10-release-evidence.mjs"],
    gates: ["npm run check:v10-release-evidence"],
  },
  {
    ...
    category: "security",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-objective-telemetry.ts"],
    gates: ["src/lib/v10-hardening-contracts.v10.test.ts", "src/lib/v10-objective-telemetry.v10.test.ts"],
  },
  {
  ...
  },
  {
    ...
    category: "quality",
    disposition: "automated_gate",
    artifacts: ["package.json", "scripts/check-v10-suite.mjs"],
    gates: ["npm run lint", "npm run typecheck", "npm run check:v10-suite"],
  },
  {
    id: "state-machine-contracts",
    category: "data",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-status-action-vocabulary.ts", "src/lib/v10-mutation-envelope.ts"],
    gates: ["src/lib/v10-status-action-vocabulary.v10.test.ts", "src/lib/v10-semantics.v10.test.ts"],
  },
  {
    id: "contract-versioning-compatibility",
    category: "api",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-release-contract.ts", "src/lib/v10-mutation-envelope.ts"],
    gates: ["src/lib/v10-release-contract.v10.test.ts", "src/lib/v10-semantics.v10.test.ts"],
  },
  {
    id: "measurement-governance",
    category: "measurement",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-objective-telemetry.ts", "src/lib/v10-readiness-scorecard.ts"],
    gates: ["src/lib/v10-objective-telemetry.v10.test.ts", "npm run check:v10-release-evidence"],
    blockerType: "external_dashboard",
  },
  {
    ...
    category: "api",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-objective-telemetry.ts", "src/lib/v10-release-contract.ts"],
    gates: ["src/lib/v10-objective-telemetry.v10.test.ts", "src/lib/v10-release-contract.v10.test.ts"],
  },
  {
  ...
  },
  {
    ...
    category: "security",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-governance.ts"],
    gates: ["src/lib/v10-hardening-contracts.v10.test.ts"],
  },
  {
  ...
  },
  {
    ...
    category: "security",
    disposition: "automated_gate",
    artifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/v10-governance.ts"],
    gates: ["npm run check:migrations", "src/lib/v10-data-contracts.v10.test.ts"],
  },
  {
    ...
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-mutation-rollout.ts", "src/lib/v10-release-evidence.ts"],
    gates: ["src/lib/v10-mutation-rollout.v10.test.ts"],
  },
  {
    id: "data-quality-remediation-loop",
    category: "data",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-field-provenance.ts", "src/lib/v10-work-semantics.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts"],
  },
  {
    ...
    category: "release",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-release-evidence.ts", "src/lib/v10-report-export.ts"],
    gates: ["src/lib/v10-release-evidence.v10.test.ts", "src/lib/v10-semantics.v10.test.ts"],
  },
  {
    id: "intake-parser-validation",
    category: "api",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-activation-state.ts", "src/app/api/import/contracts/route.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/app/api/import/contracts/route.test.ts"],
  },
  {
    ...
    category: "api",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-route-api-catalog.ts", "src/lib/v10-ui-state-contracts.ts"],
    gates: ["src/lib/v10-route-api-catalog.v10.test.ts", "src/lib/v10-ui-state-contracts.v10.test.ts"],
  },
  {
    id: "entitlement-billing-sync",
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-governance.ts", "src/lib/v10-route-api-catalog.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/lib/v10-route-api-catalog.v10.test.ts"],
  },
  {
    ...
    category: "operations",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-evidence-collaboration.ts", "src/lib/v10-hardening-contracts.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/lib/v10-hardening-contracts.v10.test.ts"],
  },
  {
    ...
    category: "security",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-report-export.ts", "src/lib/v10-objective-telemetry.ts"],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/lib/v10-objective-telemetry.v10.test.ts"],
  },
  {
    ...
    disposition: "automated_gate",
    artifacts: [
      "src/lib/v10-work-semantics.ts",
      "src/app/(dashboard)/work/page.tsx",
      "src/app/api/command-palette/contracts/route.ts",
    ],
    gates: ["src/lib/v10-semantics.v10.test.ts", "src/components/layout/command-palette.ui.test.tsx"],
  },
  {
    id: "failure-injection-qa",
    category: "quality",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-release-evidence.ts", "e2e/v10-core-smoke.spec.ts"],
    gates: ["src/lib/v10-hardening-contracts.v10.test.ts", "npm run check:v10-release-evidence", "npm run test:e2e:v10"],
  },
  {
    id: "trace-release-evidence",
    category: "release",
    disposition: "automated_gate",
    artifacts: ["src/lib/v10-spec-trace-map.ts", "src/lib/v10-implementation-checklist.ts", "src/lib/v10-release-evidence.ts"],
    gates: ["npm run check:v10-suite", "npm run check:v10-release-evidence"],
  },
  {
    ...
    disposition: "automated_gate",
    artifacts: ["scripts/check-v10-suite.mjs", "scripts/check-v10-release-evidence.mjs", "package.json"],
    gates: ["npm run check:v10-suite", "npm run typecheck", "npm run lint", "npm run check:migrations", "npm run test:e2e:v10"],
  },
] as const;
...
export function classifyV10AcceptanceRuntimeStatus(row: V10AcceptanceMatrixRow): V10AcceptanceRuntimeStatus {
  ...
  const hasRuntimeArtifact = row.artifacts.some(
    (artifact) =>
      ...
      artifact.includes("v10-read-model-refresh") ||
      artifact.includes("v10-mutation-envelope") ||
      artifact.includes("v10-server-contracts") ||
...
export function getV10AcceptanceVerificationCommands(row: V10AcceptanceMatrixRow): readonly string[] {
  ...
  return commands.length > 0 ? commands : ["npm run check:v10-suite"];
}

...
export const V10_MIGRATION_ROLLOUT_SAFETY_CONTRACTS: readonly V10MigrationRolloutSafetyContract[] = [
  {
    ...
    protectedArtifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/v10-read-models.ts"],
  ...
  },
  {
    ...
    protectedArtifacts: ["scripts/check-v10-suite.mjs", "scripts/check-v10-release-evidence.mjs", "semgrep/oblixa-v10-surface.yml"],
  ...
  },
  {
    ...
    phase: "rollout_gate",
    protectedArtifacts: ["src/lib/v10-mutation-rollout.ts", "src/lib/v10-release-contract.ts"],
...
export function buildV10BackfillRunbookManifest(input: {
  ...
  return {
    ...
    preflightCommands: [
      ...
      "npm run typecheck",
      "node scripts/check-v10-suite.mjs",
    ],

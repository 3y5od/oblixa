...
const SKIP = new Set<string>([
  ...
  join(ROOT, "lib", "product-telemetry.wiring.v9.test.ts"),
  join(ROOT, "lib", "product-telemetry.details.v9.test.ts"),
  join(ROOT, "lib", "product-telemetry.v9.test.ts"),
  join(ROOT, "lib", "v9-telemetry-tier-c-paths.v9.test.ts"),
]);

...
/**
 * Lightweight adoption / health signal for org_behavior_metrics.v6_assurance_quality_json (V6 success metrics).
 */
export async function recordV6AssuranceActivity(
  admin: AdminClient,
  orgId: string,
...
/** Known keys written by V6 routes and jobs (others may appear from JSON merges). */
export const V6_QUALITY_COUNTER_FIELDS = [
...
export async function incrementV6QualityCounter(
  admin: AdminClient,
  orgId: string,
  field: string,
  delta = 1

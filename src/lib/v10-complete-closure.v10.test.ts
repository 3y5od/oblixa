...
import { V10_RC_FIXTURE_CATEGORIES } from "./v10-objective-measurements";
...
import { V10_DEPRECATION_CLEANUP_DECISIONS } from "./v10-final-gap-audit";
...
describe("V10 complete closure", () => {
  ...
  it("creates row-level coverage for acceptance IDs, source objects, read models, mutations, routes, states, and metrics", () => {
    ...
    expect(sourceObjectRow?.proofArtifacts).toContain("src/lib/v10-source-object-inventory.ts");

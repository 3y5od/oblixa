...
export const V10_SOURCE_OBJECT_INVENTORY: readonly V10SourceObjectInventoryRow[] = [
  {
    ...
    tests: ["src/lib/data-contracts.test.ts", "e2e/current-product-core-smoke.spec.ts"],
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/semantics.test.ts", "src/actions/tasks.ts"],
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/semantics.test.ts", "src/actions/policy-operations.ts"],
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/read-model-refresh.test.ts"],
  },
  {
  ...
  },
  {
    ...
    retentionPolicy: "token_expiring",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/read-model-refresh.test.ts", "src/app/api/evidence/[id]/[action]/route.test.ts"],
  },
  {
  ...
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/read-model-refresh.test.ts", "src/app/api/cron/v10/read-model-refresh/route.test.ts"],
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/app/api/import/contracts/route.test.ts", "src/lib/read-model-refresh.test.ts"],
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/continuity.test.ts"],
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/data-contracts.test.ts", "src/lib/server-contracts.test.ts"],
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/data-contracts.test.ts", "src/lib/read-model-refresh.test.ts"],
  },
  {
  ...
  ...([
    ...
    },
    {
      ...
      tests: ["src/lib/read-model-refresh.test.ts", "src/lib/continuity.test.ts"],
    },
    {
  ...
  })),
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/lib/domain-depth-contracts.test.ts", "src/lib/read-model-refresh.test.ts"],
  },
  {
  ...
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/app/api/command-palette/contracts/route.test.ts"],
  },
  {
  ...
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_verified",
    tests: ["src/actions/product-surface-settings.test.ts", "src/lib/operational-contracts.test.ts"],
  },
  {
  ...
  },
  {
    ...
    tests: ["src/lib/operational-contracts.test.ts", "src/lib/release-evidence.test.ts"],
  },
  {
    ...
    tests: [
      "src/lib/read-model-refresh.test.ts",
      "src/lib/mutation-rollout.test.ts",
...
export { buildV10SourceObjectCoverageMatrix as buildSourceObjectCoverageMatrix };
export { getV10SourceObjectInventoryRow as getSourceObjectInventoryRow };
export { V10_SOURCE_OBJECT_INVENTORY as SOURCE_OBJECT_INVENTORY };
export { validateV10SourceObjectCoverageMatrix as validateSourceObjectCoverageMatrix };
export { validateV10SourceObjectInventory as validateSourceObjectInventory };
export type { V10SourceObjectCoverageMatrixRow as SourceObjectCoverageMatrixRow };
export type { V10SourceObjectInventoryRow as SourceObjectInventoryRow };

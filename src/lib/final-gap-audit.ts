...
import { V10_IMPLEMENTATION_REQUIREMENTS } from "./implementation-checklist";
...
import { V10_SOURCE_OBJECT_INVENTORY } from "./source-object-inventory";
...
const PLAN_TODO_PROOF_ROWS: readonly V10PlanTodoProof[] = [
  {
    ...
    owner: "release",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/no-exclusions-matrix.ts", "src/lib/implementation-checklist.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["src/lib/source-object-inventory.ts", "src/lib/read-model-refresh.ts", "src/lib/traceability-ledger.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "product",
    artifacts: ["src/lib/route-api-catalog.ts", "src/lib/ui-state-contracts.ts", "src/lib/route-api-catalog.test.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "scripts/check-migration-smoke-current.mjs", "src/lib/data-contracts.test.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["src/lib/read-models.ts", "src/lib/read-model-refresh.ts", "scripts/rebuild-read-models.mjs"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["src/lib/mutation-envelope.ts", "src/lib/server-contracts.ts", "src/lib/server-contracts.test.ts"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "operations",
    artifacts: ["src/app/api/cron/v10/read-model-refresh/route.ts", "src/lib/operational-contracts.ts", "vercel.json"],
    blocker: null,
  },
  {
    ...
    proofKind: "shipped_behavior",
    owner: "product",
    artifacts: ["src/app/(dashboard)/dashboard/page.tsx", "src/app/(dashboard)/work/page.tsx", "src/components/ui/recoverable-state.tsx"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "product",
    artifacts: ["src/lib/advanced-assurance-continuity.ts", "src/lib/domain-depth-contracts.ts", "src/lib/continuity.test.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "release",
    artifacts: ["src/lib/objective-telemetry.ts", "src/lib/release-evidence.ts", "src/lib/readiness-scorecard.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "security",
    artifacts: ["src/lib/hardening-contracts.ts", "src/lib/hardening-contracts.test.ts", "semgrep/oblixa-v10-surface.yml"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "product",
    artifacts: ["src/lib/ui-state-contracts.ts", "src/lib/operational-contracts.ts", "e2e/current-product-core-smoke.spec.ts"],
    blocker: null,
  },
  {
    ...
    owner: "release",
    artifacts: ["src/lib/release-evidence.ts", "src/lib/objective-measurements.ts", "scripts/check-release-suite-current.mjs"],
  ...
  },
  {
    ...
    proofKind: "release_evidence",
    owner: "security",
    artifacts: ["src/lib/hardening-contracts.ts", "src/lib/report-export.ts", "src/lib/operational-contracts.ts"],
  ...
  },
  {
    ...
    owner: "operations",
    artifacts: ["src/lib/operational-contracts.ts", "src/lib/hardening-contracts.ts", "scripts/check-release-evidence.mjs"],
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "release",
    artifacts: ["scripts/check-release-suite-current.mjs", "scripts/check-release-evidence.mjs", ".github/workflows/ci.yml"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "release",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/release-contract.ts", "scripts/release-preflight.mjs"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["src/lib/read-model-refresh.ts", "src/lib/read-model-refresh.test.ts"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["src/lib/server-contracts.ts", "src/actions/tasks.ts", "src/actions/product-surface-settings.ts", "src/lib/route-api-catalog.test.ts"],
    blocker: null,
  },
  {
    ...
    artifacts: [
      ...
      "src/app/api/command-palette/contracts/route.test.ts",
  ...
  },
  {
    ...
    owner: "security",
    artifacts: ["src/lib/hardening-contracts.ts", "src/lib/server-contracts.ts"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "product",
    artifacts: ["src/lib/final-gap-audit.ts", "src/app/api/command-palette/contracts/route.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "product",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/work-semantics.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "operations",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/job-visibility.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "release",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/final-gap-audit.test.ts"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "release",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/no-exclusions-matrix.ts", "src/lib/acceptance-matrix.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/read-models.ts", "scripts/check-migration-smoke-current.mjs"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["src/lib/read-model-refresh.ts", "src/lib/read-models.ts", "scripts/rebuild-read-models.mjs"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["src/lib/route-api-catalog.ts", "src/lib/server-contracts.ts", "src/app/api/command-palette/contracts/route.ts"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "product",
    artifacts: ["src/lib/core-workflow-contracts.ts", "src/lib/evidence-collaboration.ts", "src/lib/approval-exception.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "security",
    artifacts: ["src/lib/hardening-contracts.ts", "src/lib/objective-telemetry.ts", "semgrep/oblixa-v10-surface.yml"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "release",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/compatibility-release-contract.ts", "scripts/check-release-suite-current.mjs"],
    blocker: null,
  },
  {
    ...
    proofKind: "environment_gated",
    owner: "release",
    artifacts: ["src/lib/release-evidence.ts", "src/lib/readiness-scorecard.ts", "scripts/check-release-evidence.mjs"],
  ...
  },
  {
    ...
    proofKind: "release_evidence",
    owner: "release",
    artifacts: ["src/lib/objective-measurements.ts", "src/lib/objective-telemetry.ts", "src/lib/release-evidence.ts"],
  ...
  },
  {
    ...
    proofKind: "release_evidence",
    owner: "operations",
    artifacts: ["src/lib/operational-contracts.ts", "src/app/(dashboard)/settings/health/page.tsx", "src/lib/readiness-scorecard.ts"],
  ...
  },
  {
    ...
    proofKind: "release_evidence",
    owner: "security",
    artifacts: ["src/lib/hardening-contracts.ts", "src/lib/report-export.ts", "src/lib/release-evidence.ts"],
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "product",
    artifacts: ["src/lib/ui-state-contracts.ts", "e2e/current-product-core-smoke.spec.ts", "src/components/ui/recoverable-state.tsx"],
    blocker: null,
  },
  {
    ...
    proofKind: "release_evidence",
    owner: "release",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/release-evidence.ts", "src/lib/readiness-scorecard.ts"],
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "engineering",
    artifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "scripts/check-migration-smoke-current.mjs", "scripts/check-release-evidence.mjs"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "security",
    artifacts: ["src/lib/visibility.ts", "src/lib/hardening-contracts.ts", "semgrep/oblixa-v10-surface.yml"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "operations",
    artifacts: ["src/app/api/command-palette/contracts/route.ts", "src/lib/report-export.ts", "src/lib/job-visibility.ts"],
    blocker: null,
  },
  {
    ...
    proofKind: "environment_gated",
    owner: "operations",
    artifacts: ["src/app/(dashboard)/settings/health/page.tsx", "src/lib/governance.ts", "src/lib/operational-contracts.ts"],
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "product",
    artifacts: ["src/components/ui/recoverable-state.tsx", "src/lib/ui-state-contracts.ts", "e2e/current-product-core-smoke.spec.ts"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "release_evidence",
    owner: "operations",
    artifacts: ["src/lib/objective-telemetry.ts", "src/lib/operational-contracts.ts", "src/lib/readiness-scorecard.ts"],
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "operations",
    artifacts: ["src/lib/route-api-catalog.ts", "src/lib/operational-contracts.ts", "scripts/check-release-evidence.mjs"],
    blocker: null,
  },
  {
  ...
  },
  {
    ...
    proofKind: "automated_gate",
    owner: "release",
    artifacts: ["src/lib/final-gap-audit.ts", "src/lib/no-exclusions-matrix.ts", "src/lib/traceability-ledger.ts"],
    blocker: null,
  },
] as const;
...
export const V10_FROZEN_IMPLEMENTATION_MATRIX: readonly V10FrozenImplementationMatrixRow[] = [
  {
    ...
    primaryArtifacts: ["src/lib/final-gap-audit.ts", "src/lib/acceptance-matrix.ts", "src/lib/source-object-inventory.ts", "src/lib/route-api-catalog.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "scripts/check-migration-smoke-current.mjs", "scripts/check-release-evidence.mjs", "src/lib/acceptance-matrix.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/read-models.ts", "src/lib/read-model-refresh.ts", "scripts/rebuild-read-models.mjs"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/visibility.ts", "src/lib/hardening-contracts.ts", "semgrep/oblixa-v10-surface.yml"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/mutation-envelope.ts", "src/lib/server-contracts.ts", "src/lib/route-api-catalog.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/app/api/command-palette/contracts/route.ts", "src/lib/report-export.ts", "src/lib/job-visibility.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/app/(dashboard)/settings/health/page.tsx", "src/lib/governance.ts", "src/lib/operational-contracts.ts"],
  ...
  },
  {
    ...
    requiredDimensions: ["functional_coverage", "authorization", "audit", "telemetry", "recoverable_ui"],
    primaryArtifacts: ["src/lib/advanced-assurance-continuity.ts", "src/lib/domain-depth-contracts.ts", "src/lib/read-model-refresh.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/components/ui/recoverable-state.tsx", "src/lib/ui-state-contracts.ts", "e2e/current-product-core-smoke.spec.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/release-evidence.ts", "src/lib/objective-measurements.ts", "scripts/check-release-suite-current.mjs"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/objective-telemetry.ts", "src/lib/operational-contracts.ts", "src/lib/readiness-scorecard.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/route-api-catalog.ts", "src/lib/operational-contracts.ts", "scripts/check-release-evidence.mjs"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/hardening-contracts.ts", "src/lib/report-export.ts", "src/lib/release-evidence.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/final-gap-audit.ts", "src/lib/no-exclusions-matrix.ts", "src/lib/traceability-ledger.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/read-models.ts", "src/lib/data-contracts.test.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/read-model-refresh.ts", "scripts/rebuild-read-models.mjs"],
    acceptanceIds: ["read-model-foundation", "data-lineage-invariants", "seed-backfill-tooling"],
    blockerPolicy: "must_be_runtime_backed",
  },
  {
    ...
    primaryArtifacts: ["src/lib/hardening-contracts.ts", "src/lib/governance.ts", "src/lib/server-contracts.ts"],
    acceptanceIds: ["security-privacy-data", "authorization-data-classification", "tenant-isolation-proof"],
    blockerPolicy: "must_be_runtime_backed",
  },
  {
    ...
    primaryArtifacts: ["src/lib/implementation-checklist.ts", "src/lib/final-gap-audit.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/mutation-rollout.ts", "src/lib/read-model-refresh.ts", "scripts/rebuild-read-models.mjs"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/app/api/command-palette/contracts/route.ts", "src/lib/report-export.ts", "src/lib/product-telemetry.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/advanced-assurance-continuity.ts", "src/lib/domain-depth-contracts.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["scripts/check-release-suite-current.mjs", "scripts/check-release-evidence.mjs", ".github/workflows/ci.yml"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/objective-measurements.ts", "src/lib/release-evidence.ts", "src/lib/readiness-scorecard.ts"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/final-gap-audit.ts", "scripts/check-release-evidence.mjs"],
  ...
  },
  {
    ...
    primaryArtifacts: ["src/lib/release-evidence.ts", "src/lib/readiness-scorecard.ts", "src/app/(dashboard)/settings/health/page.tsx"],
...
export const V10_FILE_OWNERSHIP_MAP: readonly V10FileOwnershipRow[] = [
  ...
  { area: "audit", pathPrefix: "src/lib/status-action-vocabulary.ts", owner: "security", requiredProof: ["audit", "privacy", "compatibility"] },
  { area: "testing", pathPrefix: "e2e/", owner: "release", requiredProof: ["fixture_or_e2e"] },
  { area: "fixtures", pathPrefix: "scripts/check-release-suite-current.mjs", owner: "release", requiredProof: ["fixture_or_e2e", "release_evidence"] },
  ...
  { area: "integrations", pathPrefix: "src/lib/operational-contracts.ts", owner: "operations", requiredProof: ["integration_boundary", "release_evidence"] },
  ...
  { area: "compliance", pathPrefix: "src/lib/hardening-contracts.ts", owner: "security", requiredProof: ["privacy", "audit", "data_lifecycle"] },
  { area: "runbooks", pathPrefix: "scripts/rebuild-read-models.mjs", owner: "operations", requiredProof: ["operations", "release_evidence"] },
  { area: "verification", pathPrefix: "src/lib/final-gap-audit.ts", owner: "release", requiredProof: ["verification_matrix", "release_evidence"] },
] as const;
...
export const V10_DEPRECATION_CANDIDATES: readonly V10DeprecationCandidate[] = [
  ...
  },
  {
    ...
    artifact: "scripts/check-release-suite-current.mjs",
  ...
  },
  {
    ...
    category: "v9_label",
    artifact: "src/lib/compatibility-release-contract.ts",
...
export const V10_COMPATIBILITY_BOUNDARIES: readonly V10CompatibilityBoundary[] = [
  ...
  { key: "report_export_artifacts", boundary: "artifact", compatibilityPolicy: "preserve", owningArtifact: "src/lib/report-export.ts" },
  { key: "report_export_file_formats", boundary: "report_export_format", compatibilityPolicy: "additive_only", owningArtifact: "src/lib/report-export.ts" },
  { key: "v10_audit_action_names", boundary: "audit_action", compatibilityPolicy: "additive_only", owningArtifact: "src/lib/status-action-vocabulary.ts" },
  ...
  { key: "v10_read_model_tables", boundary: "persisted_data", compatibilityPolicy: "cleanup_after_backfill", owningArtifact: "src/lib/read-models.ts" },
  { key: "v10_api_response_schemas", boundary: "api_schema", compatibilityPolicy: "additive_only", owningArtifact: "src/lib/mutation-envelope.ts" },
  { key: "v10_private_cache_policy", boundary: "cache_policy", compatibilityPolicy: "preserve", owningArtifact: "src/lib/route-api-catalog.ts" },
  { key: "v10_provider_configuration", boundary: "provider_config", compatibilityPolicy: "additive_only", owningArtifact: "src/lib/operational-contracts.ts" },
  { key: "v10_entitlement_state", boundary: "entitlement_state", compatibilityPolicy: "preserve", owningArtifact: "src/lib/governance.ts" },
  ...
  { key: "v10_browser_support_matrix", boundary: "browser_support", compatibilityPolicy: "additive_only", owningArtifact: "e2e/current-product-core-smoke.spec.ts" },
  { key: "v9_regression_bridge", boundary: "stable_command", compatibilityPolicy: "preserve", owningArtifact: "src/lib/compatibility-release-contract.ts" },
] as const;
...
export const V10_DEPRECATION_CLEANUP_DECISIONS: readonly V10DeprecationCleanupDecision[] = [
  {
    ...
    testsPreserved: true,
    cleanupCommand: "npm run check:release-suite-current -- --cleanup work_legacy_queue_summary",
  },
  {
    candidateId: "field_review_legacy_audit_details",
    action: "quarantine",
    supersededBy: "v10_audit_events safe_metadata and hashed state",
    runtimeReplacementProof: "src/lib/status-action-vocabulary.ts",
    ...
    testsPreserved: true,
    cleanupCommand: "npm run check:release-suite-current -- --cleanup field_review_legacy_audit_details",
  },
  {
    ...
    compatibilityBoundaryKey: "v10_audit_action_names",
    testsPreserved: true,
    cleanupCommand: "npm run check:release-suite-current -- --cleanup legacy_exception_assigned_audit_alias",
  },
  {
    ...
    runtimeReplacementProof: "src/lib/report-export.ts",
    releaseEvidenceId: "v10-release:deprecation:report_pack_as_report_run",
    compatibilityBoundaryKey: "report_export_artifacts",
    testsPreserved: true,
    cleanupCommand: "npm run check:release-suite-current -- --cleanup report_pack_as_report_run",
  },
  {
    ...
    testsPreserved: true,
    cleanupCommand: "npm run check:release-suite-current -- --cleanup descriptor_only_rc_fixtures",
  },
  {
    ...
    compatibilityBoundaryKey: "package_v10_commands",
    testsPreserved: true,
    cleanupCommand: "npm run check:release-evidence -- --cleanup v10_semgrep_warning_only",
  },
  {
    ...
    compatibilityBoundaryKey: "package_v10_commands",
    testsPreserved: true,
    cleanupCommand: "npm run check:release-suite-current -- --cleanup duplicate_v10_e2e_smoke_lane",
  },
  {
    ...
    testsPreserved: true,
    cleanupCommand: "npm run check:release-suite-current && npm run check:previous-release-suite",
  },
] as const;
...
export const V10_WORK_SOURCE_ACTION_MATRIX: readonly V10WorkSourceActionContract[] = [
  ...
  auditAction,
  refreshArtifact: "src/lib/read-model-refresh.ts",
}));
...
export const V10_SOURCE_INVENTORY: readonly V10SourceInventoryEntry[] = [
  ...
  { category: "server_action", key: "tasks", artifact: "src/actions/tasks.ts", owner: "engineering", runtimeStatus: "implemented", testStatus: "unit" },
  {
    ...
    artifact: "src/actions/bulk-compatible-work.ts",
    owner: "engineering",
  ...
  { category: "read_model", key: "read_model_refresh", artifact: "src/lib/read-model-refresh.ts", owner: "engineering", runtimeStatus: "implemented", testStatus: "unit" },
  ...
  { category: "audit_action", key: "v10_audit_vocabulary", artifact: "src/lib/final-gap-audit.ts", owner: "security", runtimeStatus: "implemented", testStatus: "unit" },
  ...
  ...V10_JOB_CLASSES.map((jobClass) => ({
    ...
    key: jobClass,
    artifact: "src/lib/job-visibility.ts",
    owner: "operations" as const,
    runtimeStatus: "implemented" as const,
    testStatus: "unit" as const,
  })),
  ...
  { category: "release_artifact", key: "release_evidence", artifact: "src/lib/release-evidence.ts", owner: "release", runtimeStatus: "external_blocker", testStatus: "release_check" },
  { category: "component", key: "v10_recoverable_state", artifact: "src/components/ui/recoverable-state.tsx", owner: "product", runtimeStatus: "implemented", testStatus: "ui" },
  { category: "api_contract", key: "route_api_catalog", artifact: "src/lib/route-api-catalog.ts", owner: "engineering", runtimeStatus: "implemented", testStatus: "unit" },
  ...
  { category: "script", key: "v10_suite", artifact: "scripts/check-release-suite-current.mjs", owner: "release", runtimeStatus: "implemented", testStatus: "release_check" },
  { category: "script", key: "v10_release_evidence", artifact: "scripts/check-release-evidence.mjs", owner: "release", runtimeStatus: "implemented", testStatus: "release_check" },
  { category: "script", key: "v10_migration_smoke", artifact: "scripts/check-migration-smoke-current.mjs", owner: "engineering", runtimeStatus: "implemented", testStatus: "release_check" },
  ...
  { category: "fixture", key: "v10_core_smoke", artifact: "e2e/current-product-core-smoke.spec.ts", owner: "release", runtimeStatus: "implemented", testStatus: "e2e" },
  { category: "external_evidence_gate", key: "non_autonomous_release_gates", artifact: "src/lib/release-evidence.ts", owner: "release", runtimeStatus: "external_blocker", testStatus: "release_check" },
  { category: "runbook", key: "rebuild_read_models", artifact: "scripts/rebuild-read-models.mjs", owner: "operations", runtimeStatus: "implemented", testStatus: "release_check" },
  ...
  { category: "verification_matrix", key: "final_gap_audit", artifact: "src/lib/final-gap-audit.ts", owner: "release", runtimeStatus: "implemented", testStatus: "unit" },
] as const;
...
export function validateV10DeprecationCleanupDecisions(input: {
  ...
  for (const candidate of candidates) {
    ...
    if (
      ...
      ].some((prefix) => decision.cleanupCommand.startsWith(prefix))
    ) {
      failures.push(`${candidate.key}:stable_cleanup_command_required`);
    }
...
function buildV10NoExclusionsMatrixRow(input: {
  ...
  return {
    ...
    dataArtifact: input.dataArtifact ?? "src/lib/read-models.ts",
    uiArtifact: input.uiArtifact ?? "src/lib/ui-state-contracts.ts",
    mutationApiArtifact: input.mutationApiArtifact ?? "src/lib/route-api-catalog.ts",
...
export function buildV10NoExclusionsVerificationMatrix(
  ...
  rows.push(
    ...implementationMatrix.map((row) =>
      buildV10NoExclusionsMatrixRow({
        ...
        runtimeArtifact: row.primaryArtifacts[0] ?? "src/lib/final-gap-audit.ts",
        testArtifact: row.primaryArtifacts.find((artifact) => artifact.endsWith(".test.ts") || artifact.endsWith(".test.tsx")) ?? "src/lib/final-gap-audit.test.ts",
  ...
  rows.push(
    ...sourceInventory.map((entry) =>
      buildV10NoExclusionsMatrixRow({
        ...
        testArtifact: entry.testStatus === "release_check" ? "src/lib/release-evidence.test.ts" : "src/lib/final-gap-audit.test.ts",
  ...
  rows.push(
    ...V10_SOURCE_OBJECT_TYPES.map((sourceObject) =>
      buildV10NoExclusionsMatrixRow({
        ...
        priority: "P1",
        owner: "product",
        runtimeArtifact: "src/lib/source-object-inventory.ts",
        dataArtifact: "src/lib/read-models.ts",
        testArtifact: "src/lib/source-object-inventory.test.ts",
  ...
  rows.push(
    ...V10_ROUTE_API_CATALOG.map((route) =>
      buildV10NoExclusionsMatrixRow({
        ...
        testArtifact: "src/lib/route-api-catalog.test.ts",
        mutationApiArtifact: "src/lib/route-api-catalog.ts",
  ...
  rows.push(
    ...V10_REQUIRED_MUTATION_CONTRACTS.map((mutation) =>
      buildV10NoExclusionsMatrixRow({
        ...
        testArtifact: "src/lib/server-contracts.test.ts",
        mutationApiArtifact: "src/lib/mutation-envelope.ts",
  ...
  rows.push(
    ...V10_AUDIT_VOCABULARY_TAXONOMY.map((event) =>
      buildV10NoExclusionsMatrixRow({
        ...
        priority: "P1",
        owner: "security",
        runtimeArtifact: "src/lib/final-gap-audit.ts",
        testArtifact: "src/lib/final-gap-audit.test.ts",
  ...
  rows.push(
    ...[
      ...
      "npm run check:release-privacy-scan",
      ...
      buildV10NoExclusionsMatrixRow({
        ...
        priority: "release",
        owner: "release",
        runtimeArtifact: "scripts/check-release-suite-current.mjs",
        testArtifact: "src/lib/release-evidence.test.ts",
...
export { buildV10ClaimVsProofRows as buildClaimVsProofRows };
export { buildV10NoExclusionsVerificationMatrix as buildNoExclusionsVerificationMatrix };
export { getV10PlanTodoProof as getPlanTodoProof };
export { V10_ATTACHED_PLAN_TODO_IDS as ATTACHED_PLAN_TODO_IDS };
export { V10_AUDIT_VOCABULARY_TAXONOMY as AUDIT_VOCABULARY_TAXONOMY };
export { V10_COMMAND_QUERY_SAMPLE_SET as COMMAND_QUERY_SAMPLE_SET };
export { V10_COMPATIBILITY_BOUNDARIES as COMPATIBILITY_BOUNDARIES };
export { V10_DEPRECATION_CANDIDATES as DEPRECATION_CANDIDATES };
export { V10_DEPRECATION_CLEANUP_DECISIONS as DEPRECATION_CLEANUP_DECISIONS };
export { V10_FILE_OWNERSHIP_MAP as FILE_OWNERSHIP_MAP };
export { V10_FROZEN_IMPLEMENTATION_MATRIX as FROZEN_IMPLEMENTATION_MATRIX };
export { V10_JOB_CLASS_MATRIX as JOB_CLASS_MATRIX };
export { V10_MASTER_PLAN_TODO_IDS as MASTER_PLAN_TODO_IDS };
export { V10_REQUIRED_COMPATIBILITY_BOUNDARIES as REQUIRED_COMPATIBILITY_BOUNDARIES };
export { V10_REQUIRED_FILE_OWNERSHIP_AREAS as REQUIRED_FILE_OWNERSHIP_AREAS };
export { V10_REQUIRED_PROOF_DIMENSIONS as REQUIRED_PROOF_DIMENSIONS };
export { V10_REQUIRED_SOURCE_INVENTORY_CATEGORIES as REQUIRED_SOURCE_INVENTORY_CATEGORIES };
export { V10_SOURCE_INVENTORY as SOURCE_INVENTORY };
export { V10_WORK_SOURCE_ACTION_MATRIX as WORK_SOURCE_ACTION_MATRIX };
export { validateV10DeprecationCleanupDecisions as validateDeprecationCleanupDecisions };
export { validateV10FinalGapAudit as validateFinalGapAudit };
export { validateV10FinalGapRatchet as validateFinalGapRatchet };
export { validateV10NoExclusionsVerificationMatrix as validateNoExclusionsVerificationMatrix };
export { validateV10Phase0InventoryLock as validatePhase0InventoryLock };
export { validateV10SourceInventory as validateSourceInventory };
export type { V10AttachedPlanTodoId as AttachedPlanTodoId };
export type { V10AuditVocabularyContract as AuditVocabularyContract };
export type { V10ClaimVsProofRow as ClaimVsProofRow };
export type { V10CommandQuerySample as CommandQuerySample };
export type { V10CompatibilityBoundary as CompatibilityBoundary };
export type { V10DeprecationCandidate as DeprecationCandidate };
export type { V10DeprecationCleanupDecision as DeprecationCleanupDecision };
export type { V10FileOwnershipArea as FileOwnershipArea };
export type { V10FileOwnershipRow as FileOwnershipRow };
export type { V10FrozenImplementationMatrixRow as FrozenImplementationMatrixRow };
export type { V10JobClassContract as JobClassContract };
export type { V10MasterPlanTodoId as MasterPlanTodoId };
export type { V10NoExclusionsMatrixKind as NoExclusionsMatrixKind };
export type { V10NoExclusionsVerificationMatrixRow as NoExclusionsVerificationMatrixRow };
export type { V10PlanTodoProof as PlanTodoProof };
export type { V10ProofDimension as ProofDimension };
export type { V10ProofKind as ProofKind };
export type { V10SourceInventoryEntry as SourceInventoryEntry };
export type { V10WorkSourceActionContract as WorkSourceActionContract };

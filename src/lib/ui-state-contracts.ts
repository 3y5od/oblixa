...
export const V10_VISUAL_REGRESSION_STATE_CONTRACTS: readonly V10VisualRegressionStateContract[] = [
  ...
  },
  {
    ...
    reducedMotionCovered: true,
    highContrastCovered: true,
    proofArtifact: "src/lib/report-export.test.ts",
  },
  {
...
export { V10_ACCESSIBILITY_CONTRACTS as ACCESSIBILITY_CONTRACTS };
export { V10_BACKGROUND_REFRESH_PRESERVATION as BACKGROUND_REFRESH_PRESERVATION };
export { V10_BROWSER_DEVICE_PROFILES as BROWSER_DEVICE_PROFILES };
export { V10_PERFORMANCE_BUDGETS as PERFORMANCE_BUDGETS };
export { V10_RECOVERABILITY_FAILURE_MODE_MATRIX as RECOVERABILITY_FAILURE_MODE_MATRIX };
export { V10_RESPONSIVE_CONTRACTS as RESPONSIVE_CONTRACTS };
export { V10_ROUTE_STATE_MATRIX as ROUTE_STATE_MATRIX };
export { V10_UI_STATE_CONTRACTS as UI_STATE_CONTRACTS };
export { V10_VISUAL_REGRESSION_STATE_CONTRACTS as VISUAL_REGRESSION_STATE_CONTRACTS };
export { validateV10BrowserDeviceProfiles as validateBrowserDeviceProfiles };
export { validateV10InteractiveControlA11y as validateInteractiveControlA11y };
export { validateV10RecoverabilityFailureModeMatrix as validateRecoverabilityFailureModeMatrix };
export { validateV10RoutePerformanceBudget as validateRoutePerformanceBudget };
export { validateV10RouteStateMatrix as validateRouteStateMatrix };
export { validateV10UiStateContract as validateUiStateContract };
export { validateV10UxStateMachineCoverage as validateUxStateMachineCoverage };
export { validateV10VisualRegressionStateContracts as validateVisualRegressionStateContracts };
export type { V10BrowserDeviceProfile as BrowserDeviceProfile };
export type { V10InteractiveControlA11yAudit as InteractiveControlA11yAudit };
export type { V10RecoverabilityFailureMode as RecoverabilityFailureMode };
export type { V10RecoverabilityFailureModeMatrixRow as RecoverabilityFailureModeMatrixRow };
export type { V10RecoverableUiState as RecoverableUiState };
export type { V10RouteStateMatrixEntry as RouteStateMatrixEntry };
export type { V10UiStateContract as UiStateContract };
export type { V10UxStateMachineCoverageInput as UxStateMachineCoverageInput };
export type { V10VisualRegressionStateContract as VisualRegressionStateContract };

...
const DENIAL_STATUS_MAP: Record<EligibilityDenialClass, 401 | 403 | 404> = {
  unauthenticated: 401,
...
export function statusForEligibilityDenial(
  denialClass: EligibilityDenialClass | null | undefined,
...
export function denialStatusMatrix(): Record<EligibilityDenialClass, 401 | 403 | 404> {
  return { ...DENIAL_STATUS_MAP };
}

/** @deprecated Use denialStatusMatrix. */
export const v8DenialStatusMatrix = denialStatusMatrix;

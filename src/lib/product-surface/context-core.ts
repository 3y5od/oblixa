 ...
 *
 * **§5 layers → flags**
 * - **Layer 1 (Core)** — Always the default narrative: primary nav for Dashboard,
 *   Contracts, Work, Renewals, Evidence, Reports, and Settings, with review,
 *   exceptions, imports, and report history exposed as contextual destinations;
 *   mode `core` unless org JSON overrides.

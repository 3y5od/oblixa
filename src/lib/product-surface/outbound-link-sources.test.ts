...
const EXPECTED_ALLOWLIST = [
  "src/lib/decision-intelligence/control-room-dashboard.ts",
  "src/lib/assurance/review-board-notifications.ts",
] as const;

function readAllowlistRows(): string[] {
  const p = path.join(process.cwd(), "scripts/compatibility-href-audit-allowlist.txt");

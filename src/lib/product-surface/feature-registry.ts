...
export const PRODUCT_FEATURE_REGISTRY: ProductFeatureDef[] = [
  ...
  { key: "work", label: "Tasks", ...CORE_DEF, routePrefixes: ["/work", "/contracts/tasks", "/contracts/obligations", "/contracts/approvals"], apiPrefixes: ["/tasks", "/approvals"] },
  { key: "renewals", label: "Renewals", ...CORE_DEF, routePrefixes: ["/renewals", "/contracts/renewals"], apiPrefixes: ["/renewals", "/export/renewals"] },
  { key: "exceptions", label: "Issues", ...CORE_DEF, routePrefixes: ["/contracts/exceptions"], apiPrefixes: ["/exceptions"] },
  {
    key: "evidence",
    label: "Evidence",
    ...CORE_DEF,
...
export const SEARCH_INDEX_CLASSES: SearchIndexClassDef[] = [
  ...
  { key: "obligations", label: "Requirements", featureFamily: "work", minWorkspaceMode: "core", minRole: "viewer", globalSearch: true, domainOnlySearch: false },
  ...
  { key: "exceptions", label: "Issues", featureFamily: "exceptions", minWorkspaceMode: "core", minRole: "viewer", globalSearch: true, domainOnlySearch: false },

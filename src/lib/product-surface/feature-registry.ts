...
export const PRODUCT_FEATURE_REGISTRY: ProductFeatureDef[] = [
  {
    ...
    apiPrefixes: ["/contracts", "/export/contracts"],
  },
  ...
  { key: "renewals", label: "Renewals", ...CORE_DEF, routePrefixes: ["/contracts/renewals"], apiPrefixes: ["/renewals"] },
  ...
  },
  {
    ...
    apiPrefixes: ["/reports", "/report-packs", "/export/review-packet", "/export/calendar"],
  },
  {
    key: "settings",
    label: "Settings",

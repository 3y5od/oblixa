...
import { resolveFeatureMappingForAction } from "@/lib/product-surface/surface-mapping";
import { resolveActionExemptSurface } from "@/lib/product-surface/exempt-surfaces";
...
function readTestExemptions(rootDir: string): V8TestExemptionRow[] {
  const p = path.join(rootDir, "src/lib/product-surface/test-exemptions.json");
 ...
 * auth failure and org-scope / eligibility themes, or a `test-exemptions.json` row.
 */
...
export { collectV8ActionTaxonomyViolations as collectActionTaxonomyViolations };
export { collectV8GovernedActionTestCoverageViolations as collectGovernedActionTestCoverageViolations };
export { collectV8ServerActionEligibilityViolations as collectServerActionEligibilityViolations };
export type { V8ActionEligibilityViolation as ActionEligibilityViolation };
export type { V8ActionTaxonomyViolation as ActionTaxonomyViolation };
export type { V8ActionTestCoverageViolation as ActionTestCoverageViolation };
export type { V8TestExemptionRow as TestExemptionRow };

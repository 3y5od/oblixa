...
export function buildV10CompleteClosureRows(): V10CompleteClosureRow[] {
  ...
  const rows: V10CompleteClosureRow[] = [
    row({
      ...
      owner: "release",
      proofArtifacts: ["src/lib/acceptance-matrix.ts"],
    ...
    row({
      ...
      owner: "engineering",
      proofArtifacts: ["src/lib/source-object-inventory.ts"],
      gates: ["src/lib/source-object-inventory.test.ts"],
    ...
    row({
      ...
      owner: "engineering",
      proofArtifacts: ["src/lib/read-models.ts", "src/lib/read-model-refresh.ts"],
    ...
    row({
      ...
      owner: "engineering",
      proofArtifacts: ["src/lib/mutation-envelope.ts", "src/lib/server-contracts.ts"],
      gates: ["src/lib/semantics.test.ts", "src/lib/mutation-rollout.test.ts"],
    ...
    row({
      ...
      owner: "engineering",
      proofArtifacts: ["src/lib/route-api-catalog.ts", "src/app"],
      gates: ["src/lib/route-api-catalog.test.ts"],
    ...
    row({
      ...
      owner: "product",
      proofArtifacts: ["src/lib/ui-state-contracts.ts", "src/components/ui/recoverable-state.tsx"],
      gates: ["src/lib/ui-state-contracts.test.ts", "src/components/ui/recoverable-state.test.tsx"],
    ...
    row({
      ...
      owner: "release",
      proofArtifacts: ["src/lib/objective-measurements.ts", "scripts/check-release-evidence.mjs"],
      gates: ["src/lib/objective-measurements.test.ts", "npm run check:release-evidence"],
    ...
    row({
      ...
      owner: "release",
      proofArtifacts: ["src/lib/release-evidence.ts", "src/lib/readiness-scorecard.ts"],
      gates: ["src/lib/release-evidence.test.ts", "src/lib/readiness-scorecard.test.ts"],
    ...
    row({
      ...
      owner: "release",
      proofArtifacts: ["src/lib/no-exclusions-matrix.ts"],
      gates: ["src/lib/no-exclusions-matrix.test.ts"],
    ...
    row({
      ...
      owner: "operations",
      proofArtifacts: ["src/lib/release-contract.ts", "src/lib/final-gap-audit.ts"],
      gates: ["src/lib/final-gap-audit.test.ts"],
  ...
  for (const sourceObject of sourceObjectMatrix) {
    ...
    rows.push(
      row({
        ...
        gates: inventoryRow?.tests ?? ["src/lib/source-object-inventory.test.ts"],
  ...
  for (const metric of V10_OBJECTIVE_MEASUREMENT_RULES) {
    ...
    rows.push(
      row({
        ...
        gates: [
          "src/lib/objective-measurements.test.ts",
          capturePlan?.captureCommand ?? "npm run check:release-evidence",
        ],
  ...
  for (const runtime of V10_JOB_NOTIFICATION_RUNTIME_CONTRACTS) {
    rows.push(
      row({
        ...
        owner: "operations",
        proofArtifacts: ["src/lib/job-visibility.ts", "src/lib/read-model-refresh.ts"],
        gates: ["src/lib/job-visibility.test.ts", "src/lib/read-model-refresh.test.ts"],
  ...
  for (const fixture of V10_RC_FIXTURE_CATEGORIES) {
    rows.push(
      row({
        ...
        owner: "release",
        proofArtifacts: ["src/lib/objective-measurements.ts", "scripts/check-release-evidence.mjs"],
        gates: ["src/lib/objective-measurements.test.ts", "npm run check:release-privacy-scan"],
    ...
    rows.push(
      row({
        ...
        proofArtifacts: [
          ...
          candidate?.artifact ?? "src/lib/final-gap-audit.ts",
          decision.runtimeReplacementProof,
          boundary?.owningArtifact ?? "src/lib/final-gap-audit.ts",
        ],
        gates: ["src/lib/final-gap-audit.test.ts", decision.cleanupCommand],
    ...
    rows.push(
      row({
        ...
        proofArtifacts: [
          ...
          ops.cronRoute ?? "src/lib/readiness-scorecard.ts",
        ],
        gates: ["src/lib/operational-contracts.test.ts", ops.rollbackCommand],
  ...
  for (const provider of V10_PROVIDER_BOUNDARIES) {
    rows.push(
      row({
        ...
        owner: "operations",
        proofArtifacts: ["src/lib/operational-contracts.ts", "src/app/(dashboard)/settings/health/page.tsx"],
        gates: ["src/lib/operational-contracts.test.ts", "npm run check:release-evidence -- --external-blockers"],
  ...
  for (const mutation of V10_REQUIRED_MUTATION_CONTRACTS) {
    rows.push(
      row({
        ...
        key: mutation.key,
        owner: "engineering",
        proofArtifacts: [mutation.runtimeArtifact, "src/lib/mutation-envelope.ts"],
  ...
  for (const route of routeInventory) {
    ...
    rows.push(
      row({
        ...
        proofArtifacts: ["src/lib/route-api-catalog.ts", runtimeArtifact, testArtifact],
        gates: [testArtifact, "src/lib/route-api-catalog.test.ts"],
...
export { buildV10CompleteClosureReport as buildCompleteClosureReport };
export { buildV10CompleteClosureRows as buildCompleteClosureRows };
export { validateV10CompleteClosureReport as validateCompleteClosureReport };
export type { V10CompleteClosureDomain as CompleteClosureDomain };
export type { V10CompleteClosureReport as CompleteClosureReport };
export type { V10CompleteClosureRow as CompleteClosureRow };
export type { V10CompleteClosureStatus as CompleteClosureStatus };

    ...
    expect(buildV10ObjectiveEvidenceExportRows([passing], new Date("2026-04-26T00:00:00Z"))).toEqual([
      {
        ...
        evidence_command: "npm run check:release-evidence -- --metric activation --lock fixtures-v10:activation:100",
      ...
      validateV10ObjectiveMetricCapturePaths([
        {
          ...
          releaseEvidenceCommand: "npm run check:release-evidence",

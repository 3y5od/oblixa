...
import { createRow, createFindingEvent } from "@/lib/assurance/service";
import { nowIso } from "@/lib/decision-intelligence/api";
import { gatherPortfolioMetrics } from "@/lib/assurance/portfolio-metrics";
import { evaluatePublishedControlPolicies, type PolicyEvaluationResult } from "@/lib/assurance/policy-evaluator";
import { applyPolicyEnforcementForEvaluations } from "@/lib/assurance/policy-enforcement-router";
import { recordAssuranceActivity } from "@/lib/assurance/telemetry";
import { buildSegmentRollupsForOrg } from "@/lib/assurance/segment-rollups";
...
export async function runModularAssuranceChecks(
  ...
  await recordAssuranceActivity(admin, orgId, {

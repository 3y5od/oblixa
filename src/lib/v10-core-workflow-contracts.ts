import type { V10RecoverableUiState } from "./v10-ui-state-contracts";
import type { V10ReadModelRefreshScope } from "./v10-read-model-refresh";
import { V10_REQUIRED_READ_MODEL_KEYS } from "./v10-read-models";
import { V10_SOURCE_OBJECT_TYPES } from "./v10-release-contract";
...
export const V10_CORE_WORKFLOW_CONTRACTS: readonly V10CoreWorkflowContract[] = [
  ...
  },
  {
    ...
    objectiveSignal: "daily_action_clearance",
    autonomousProofs: ["src/app/(dashboard)/work/page.tsx", "src/lib/v10-work-semantics.ts"],
  },
  {
    id: "contract_record",
    priority: "P0",
    ...
    autonomousProofs: ["src/app/(dashboard)/contracts/[id]/page.tsx", "src/lib/v10-contract-health.ts"],
  },
  {
    ...
    objectiveSignal: "activation_first_work_item",
    autonomousProofs: ["src/lib/v10-field-provenance.ts", "src/actions/v4.ts"],
  },
  {
    ...
    autonomousProofs: ["src/lib/v10-renewal-posture.ts", "src/app/api/renewals/[id]/[action]/route.ts"],
  },
] as const;
...
export const V10_END_TO_END_DOMAIN_WORKFLOW_CONTRACTS: readonly V10EndToEndDomainWorkflowContract[] = [
  {
    ...
    requiredProofs: ["src/lib/v10-activation-state.ts", "src/app/(dashboard)/dashboard/page.tsx"],
  },
  {
    id: "review",
    routeOrAction: "src/actions/v4.ts",
    ...
    requiredProofs: ["src/lib/v10-field-provenance.ts", "src/actions/v4.ts"],
  },
  {
    id: "renewal",
    ...
    visibleStates: ["empty", "partial", "failed", "success"],
    recoveryDestination: "/contracts/[id]",
    requiredProofs: ["src/lib/v10-renewal-posture.ts", "src/app/api/renewals/[id]/[action]/route.ts"],
  },
  {
    id: "obligation",
    ...
    requiredProofs: ["src/actions/obligations.ts", "src/lib/v10-read-model-refresh.ts"],
  },
  {
    id: "evidence",
    ...
    requiredProofs: ["src/lib/v10-evidence-collaboration.ts", "src/app/api/evidence/[id]/[action]/route.ts"],
  },
  {
    id: "approval",
    ...
    requiredProofs: ["src/lib/v10-approval-exception.ts", "src/app/api/approvals/[id]/[action]/route.ts"],
  },
  {
    id: "exception",
    ...
    requiredProofs: ["src/lib/v10-approval-exception.ts", "src/app/api/exceptions/[id]/[action]/route.ts"],
  },
  {
    id: "report",
  ...
  },
  {
    ...
    requiredProofs: ["src/actions/product-surface-settings.ts", "src/lib/v10-read-model-refresh.ts"],
  },
  {
    id: "settings",
    routeOrAction: "src/actions/product-surface-settings.ts",
  ...
  },
  {
    ...
    requiredProofs: ["src/lib/v10-advanced-assurance-continuity.ts", "src/app/(dashboard)/decisions/page.tsx"],
  },
  {
    id: "assurance",
    ...
    requiredProofs: ["src/lib/v10-advanced-assurance-continuity.ts", "src/app/(dashboard)/assurance/page.tsx"],
  },
  {
    id: "shipped_p2",
    routeOrAction: "/work",
    ...
    requiredProofs: ["src/lib/v10-domain-depth-contracts.ts", "src/lib/v10-read-model-refresh.ts"],
  },
] as const;

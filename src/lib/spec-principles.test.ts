...
const THEME_ANCHORS: { theme: string; files: string[] }[] = [
  ...
  { theme: "reliability", files: ["src/lib/job-lifecycle-copy.ts"] },
  { theme: "performance", files: ["src/components/layout/page-load-reporter.tsx"] },
  ...
  { theme: "quality of visible behavior", files: ["src/lib/hardening.test.ts"] },
];

import { V10_ACCEPTANCE_GATES, V10_GA_SAMPLE_SIZES, type V10AcceptanceGate } from "./release-contract";
...
export const V10_RC_FIXTURE_MANIFESTS: readonly V10RcFixtureManifest[] = V10_OBJECTIVE_MEASUREMENT_RULES.map((rule) => ({
  ...
  rebuildCommand: `npm run check:release-suite-current -- --fixture ${rule.metricKey}`,
  cleanupCommand: `npm run check:release-suite-current -- --cleanup-fixture ${rule.metricKey}`,
  privacyScanCommand: `npm run check:release-evidence -- --privacy-scan ${rule.metricKey}`,
...
export const V10_RC_METRIC_CAPTURE_PLANS: readonly V10RcMetricCapturePlan[] = V10_OBJECTIVE_MEASUREMENT_RULES.map((rule) => ({
  ...
  captureCommand: `npm run check:release-evidence -- --metric ${rule.metricKey} --lock v10-rc:${rule.metricKey}:${rule.fixedSampleSize}`,
  teardownCommand: `npm run check:release-suite-current -- --cleanup-fixture ${rule.metricKey}`,
...
export const V10_OBJECTIVE_METRIC_CAPTURE_PATHS: readonly V10ObjectiveMetricCapturePath[] =
  V10_OBJECTIVE_MEASUREMENT_RULES.map((rule) => ({
    ...
    releaseEvidenceCommand: `npm run check:release-evidence -- --metric ${rule.metricKey} --lock v10-rc:${rule.metricKey}:${rule.fixedSampleSize}`,
...
export function buildV10ObjectiveEvidenceExportRows(
  ...
  return runs.map((run, index) => {
    ...
    return {
      ...
      evidence_command: `npm run check:release-evidence -- --metric ${run.metricKey} --lock ${run.denominatorLockId ?? "missing"}`,
...
export { buildV10ObjectiveEvidenceExportRows as buildObjectiveEvidenceExportRows };
export { canPromoteV10ObjectiveMeasurement as canPromoteObjectiveMeasurement };
export { getV10DeterministicFixtureSeed as getDeterministicFixtureSeed };
export { getV10ObjectiveMeasurementPassRate as getObjectiveMeasurementPassRate };
export { getV10ObjectiveMeasurementRule as getObjectiveMeasurementRule };
export { getV10SloDashboardKeyForMetric as getSloDashboardKeyForMetric };
export { V10_OBJECTIVE_MEASUREMENT_RULES as OBJECTIVE_MEASUREMENT_RULES };
export { V10_OBJECTIVE_METRIC_CAPTURE_PATHS as OBJECTIVE_METRIC_CAPTURE_PATHS };
export { V10_OBJECTIVE_PROMOTION_EVIDENCE_CAPTURE as OBJECTIVE_PROMOTION_EVIDENCE_CAPTURE };
export { V10_RC_FIXTURE_CATEGORIES as RC_FIXTURE_CATEGORIES };
export { V10_RC_FIXTURE_MANIFESTS as RC_FIXTURE_MANIFESTS };
export { V10_RC_METRIC_CAPTURE_PLANS as RC_METRIC_CAPTURE_PLANS };
export { V10_RC_SEEDED_JOURNEYS as RC_SEEDED_JOURNEYS };
export { V10_RC_TEARDOWN_GUARDS as RC_TEARDOWN_GUARDS };
export { V10_SYNTHETIC_METRIC_DESCRIPTORS as SYNTHETIC_METRIC_DESCRIPTORS };
export { validateV10ObjectiveMeasurementRun as validateObjectiveMeasurementRun };
export { validateV10ObjectiveMetricCapturePaths as validateObjectiveMetricCapturePaths };
export { validateV10ObjectivePromotionEvidenceCapture as validateObjectivePromotionEvidenceCapture };
export { validateV10RcFixtureCategoryDescriptors as validateRcFixtureCategoryDescriptors };
export { validateV10RcFixtureManifestSet as validateRcFixtureManifestSet };
export { validateV10RcMetricCapturePlans as validateRcMetricCapturePlans };
export { validateV10RcSeededJourneys as validateRcSeededJourneys };
export { validateV10RcTeardownGuards as validateRcTeardownGuards };
export { validateV10SyntheticMetricDescriptors as validateSyntheticMetricDescriptors };
export type { V10ObjectiveEvidenceExportRow as ObjectiveEvidenceExportRow };
export type { V10ObjectiveMeasurementKey as ObjectiveMeasurementKey };
export type { V10ObjectiveMeasurementRule as ObjectiveMeasurementRule };
export type { V10ObjectiveMeasurementRun as ObjectiveMeasurementRun };
export type { V10ObjectiveMeasurementWindow as ObjectiveMeasurementWindow };
export type { V10ObjectiveMetricCapturePath as ObjectiveMetricCapturePath };
export type { V10ObjectivePromotionEvidenceCapture as ObjectivePromotionEvidenceCapture };
export type { V10RcFixtureCategory as RcFixtureCategory };
export type { V10RcFixtureCategoryDescriptor as RcFixtureCategoryDescriptor };
export type { V10RcFixtureManifest as RcFixtureManifest };
export type { V10RcMetricCapturePlan as RcMetricCapturePlan };
export type { V10RcSeededJourney as RcSeededJourney };
export type { V10RcTeardownGuard as RcTeardownGuard };
export type { V10SyntheticMetricDescriptor as SyntheticMetricDescriptor };

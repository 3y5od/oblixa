...
export const V10_AUTONOMOUS_COVERAGE_CONTRACTS: readonly V10CoverageContract[] = [
  {
    ...
    sourceArtifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/v10-data-contracts.v10.test.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-read-model-refresh.ts", "src/app/api/import/contracts/route.ts", "src/app/api/evidence/[id]/[action]/route.ts", "src/app/api/cron/v4/evidence-followup/route.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/app/api/contracts/recompute-signals/route.ts", "src/app/api/cron/v4/evidence-followup/route.ts", "src/app/api/reports/send-summaries/route.ts", "src/lib/v10-job-visibility.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-route-api-catalog.ts", "src/lib/v10-ui-state-contracts.ts", "src/app/(dashboard)/settings/health/page.tsx"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-read-model-refresh.ts", "src/lib/v10-implementation-checklist.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-advanced-assurance-continuity.ts", "src/lib/v10-read-model-refresh.ts", "src/lib/v10-continuity.v10.test.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-ui-state-contracts.ts", "src/lib/v10-route-api-catalog.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-release-evidence.ts", "src/lib/v10-readiness-scorecard.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-server-contracts.v10.test.ts", "src/lib/v10-data-contracts.v10.test.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-objective-telemetry.ts", "src/lib/v10-hardening-contracts.ts", "src/app/(dashboard)/settings/health/page.tsx"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-traceability-ledger.ts", "src/lib/v10-spec-trace-map.ts", "src/lib/v10-implementation-checklist.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-route-api-catalog.ts", "src/actions/tasks.ts", "src/actions/approvals.ts", "src/actions/exceptions.ts", "src/actions/product-surface-settings.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-work-semantics.ts", "src/lib/v10-read-model-refresh.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-read-model-refresh.ts", "src/app/api/contracts/recompute-signals/route.ts", "src/app/(dashboard)/settings/health/page.tsx"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/v10-route-api-catalog.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-operational-contracts.ts", "src/lib/v10-work-semantics.ts", "src/lib/v10-renewal-posture.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-release-evidence.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-status-action-vocabulary.ts", "src/lib/v10-ui-state-contracts.ts", "src/components/layout/command-palette.tsx"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-server-contracts.ts", "src/lib/v10-hardening-contracts.ts", "src/lib/v10-release-evidence.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-hardening-contracts.ts", "src/lib/v10-objective-telemetry.ts", "src/app/(dashboard)/settings/health/page.tsx"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-work-semantics.ts", "src/lib/v10-contract-health.ts", "src/lib/v10-renewal-posture.ts", "src/lib/v10-release-evidence.ts", "src/app/api/command-palette/contracts/route.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["e2e/v10-core-smoke.spec.ts", "src/lib/v10-implementation-checklist.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-operational-contracts.ts", "src/lib/v10-mutation-envelope.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-operational-contracts.ts", "src/lib/v10-hardening-contracts.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-autonomous-coverage.ts", "src/lib/v10-traceability-ledger.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-autonomous-coverage.ts", "src/lib/v10-release-evidence.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-release-contract.ts", "scripts/check-v10-release-evidence.mjs"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-mutation-rollout.ts", "src/lib/v10-read-model-refresh.ts", "src/app/(dashboard)/settings/health/page.tsx"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["scripts/pipelines/pipeline-surface-suite.mjs", "scripts/check-v10-suite.mjs"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["scripts/check-v10-release-evidence.mjs", "scripts/check-v10-suite.mjs", "package.json"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-readiness-scorecard.ts", "src/lib/v10-release-evidence.ts", "src/lib/v10-hardening-contracts.ts"],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: [
      "src/lib/v10-mutation-rollout.ts",
      "src/lib/v10-operational-contracts.ts",
      "src/lib/v10-release-evidence.ts",
      "src/lib/v10-hardening-contracts.ts",
    ],
  ...
  },
  {
    ...
    status: "shipped_behavior",
    sourceArtifacts: ["src/lib/v10-readiness-scorecard.ts", "src/lib/v10-release-evidence.ts"],

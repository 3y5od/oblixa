...
const TIER_FILES: Readonly<Record<string, string[]>> = {
  ...
  "tier13-lib-property-tests": ["src/lib/qa/contracts-search-url-fuzz-sampling.v9.test.ts"],
  "tier14-nextjs-shell": ["src/lib/qa/next-app-router-shell-surface.v9.test.ts"],
  "tier15-telemetry-sentry-tests": ["src/lib/qa/telemetry-sentry-capture-mocks.v9.test.ts"],
  ...
  "tier20-v9-e2e-trace": ["src/lib/v9-acceptance-bundle.v9.test.ts"],
  ...
  "tier25-import-preview-errors": ["src/lib/qa/csv-formula-safety-usage.v9.test.ts"],
  "tier26-routing-anchors-csp": ["e2e/authenticated.spec.ts"],
  "tier27-pwa-seo-meta": ["src/lib/qa/pwa-seo-metadata.v9.test.ts", "e2e/marketing-public.spec.ts"],
  ...
  "tier60-legal-geo-structured": ["src/lib/qa/landing-structured-data.v9.test.ts", "e2e/public-route-h1-contract.spec.ts"],
  ...
  "tier69-fuzz-property-inputs": ["src/lib/qa/contracts-search-url-fuzz-sampling.v9.test.ts"],
  "tier70-coverage-mappa-mundi": ["src/lib/qa/plan-tiers-7-83-traceability.v9.test.ts"],
  ...
  "tier75-cidr-allowlist": ["src/lib/qa/cidr.v9.test.ts"],
  "tier76-kbd-accel-os": [
  ...
  "tier79-aria-1-3-future": ["src/lib/qa/aria-future-detect.v9.test.ts"],
  "tier80-privacy-strict-contexts": ["e2e/ui-qa-skip-lab-tiers.spec.ts"],
  "tier81-dnd-clipboard": ["e2e/ui-qa-skip-lab-tiers.spec.ts"],
  "tier82-regulatory-ids": ["src/lib/qa/regulatory-id-format-sampling.v9.test.ts"],

...
export const V10_SOURCE_OBJECT_INVENTORY: readonly V10SourceObjectInventoryRow[] = [
  ...
  },
  {
    ...
    minimumMode: "core",
    workItemType: "evidence_request",
    readModels: ["external_evidence_submissions", "evidence_request_statuses", "work_items", "audit_events"],
  ...
  },
  {
    ...
    autonomousStatus: "runtime_mapped",
    tests: ["src/lib/v10-report-export.ts", "src/app/api/report-packs/route.test.ts"],
  },
  {
    ...
    retentionPolicy: "artifact_expiring",
    autonomousStatus: "runtime_mapped",
    tests: ["src/app/api/export/contracts/route.test.ts"],
  },
  {
    ...
    retentionPolicy: "source_retained",
    autonomousStatus: "runtime_mapped",
    tests: ["src/app/api/import/contracts/route.test.ts"],
  },
  {
  ...
  },
  {
    ...
    minimumMode: "core",
    workItemType: "extraction_failure",
    readModels: ["job_run_visibility", "activation_state", "work_items", "audit_events"],
    commandSearch: "eligible_when_visible",
  ...
  },
  {
    ...
    readModels: ["advanced_assurance_linked_records", "job_run_visibility", "work_items"],
    commandSearch: "eligible_when_visible",
  ...
  },
  {
    ...
    organizationScope: "required",
    ownerField: "recipient_user_id",
    statusField: "delivery_status",
    dueField: "scheduled_at",
    visibilityField: null,
    featureFamily: "notifications",
    minimumMode: "core",
    workItemType: null,
    readModels: ["notification_deliveries", "job_run_visibility"],
    commandSearch: "eligible_when_visible",
  ...
  },
  {
    ...
    minimumMode: "core",
    workItemType: null,
    readModels: ["renewal_posture_snapshots", "notification_deliveries"],
    commandSearch: "eligible_when_visible",
  ...
  ...[
    ["finding", "assurance_findings", "findings", "assurance"],
    ["control", "control_policies", "control_policies", "assurance"],
    ["campaign", "portfolio_campaigns", "campaigns", "advanced"],
    ["decision", "decision_workspaces", "decisions", "advanced"],
    ["simulation", "change_simulations", "simulations", "advanced"],
    ["program", "portfolio_programs", "programs", "advanced"],
    ["scorecard", "assurance_scorecards", "scorecards", "assurance"],
    ["playbook", "adaptive_playbook_runs", "playbooks", "assurance"],
    ["review_board", "review_boards", "review_boards", "assurance"],
    ["health_graph", "portfolio_health_graph_edges", "health_graph", "assurance"],
  ].map(([sourceObjectType, sourceTable, featureFamily, mode]) => ({
    sourceObjectType: sourceObjectType as V10SourceObjectType,
    sourceTable,
    ...
    visibilityField: null,
    featureFamily,
    minimumMode: mode as "advanced" | "assurance",
    workItemType: sourceObjectType === "playbook" ? "automation_approval" : null,
    readModels: sourceObjectType === "playbook"
      ? ["advanced_assurance_linked_records", "work_items", "command_search_index"]
      : ["advanced_assurance_linked_records", "command_search_index"],
    commandSearch: "eligible_when_visible" as const,
    auditActions: [`${sourceObjectType}.linked`],
    telemetryObjectives: ["daily_action_clearance"],
    reportExportInclusion: "eligible" as const,
    retentionPolicy: "source_retained" as const,
    autonomousStatus: sourceObjectType === "program" ? "runtime_mapped" as const : "runtime_verified" as const,
    tests: sourceObjectType === "program" ? ["src/lib/v10-continuity.v10.test.ts"] : ["src/lib/v10-read-model-refresh.v10.test.ts"],
  })),
  {
  ...
  },
  {
    ...
    sourceTable: "notification_destinations",
    organizationScope: "required",
    ownerField: "updated_by",
    statusField: "status",
    dueField: null,
    visibilityField: "disabled_at",
    featureFamily: "settings",
    minimumMode: "core",
    workItemType: null,
    readModels: ["notification_deliveries", "command_search_index", "audit_events"],
    commandSearch: "required",
  ...
  },
  {
    ...
    retentionPolicy: "artifact_expiring",
    autonomousStatus: "runtime_mapped",
    tests: ["src/lib/v10-mutation-rollout.v10.test.ts", "src/lib/v10-hardening-contracts.v10.test.ts"],
  },
] as const;

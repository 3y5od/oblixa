...
import type { V10Plan, V10Role, V10WorkspaceMode } from "./release-contract";
import {
...
import { V10_PERFORMANCE_BUDGETS } from "./ui-state-contracts";
...
const V10_DASHBOARD_PAGE_ARTIFACTS: Record<string, string> = {
  ...
  "/renewals": "src/app/(dashboard)/renewals/page.tsx",
  ...
  "/evidence": "src/app/(dashboard)/evidence/page.tsx",
...
export const V10_ROUTER_JOBS_REPORTS_BOUNDARY_CONTRACTS: readonly V10RouterJobsReportsBoundaryContract[] = [
  ...
  },
  {
    ...
    primaryRoute: "/settings/operations",
    ...
    requiredProofs: ["src/lib/job-visibility.ts", "src/actions/product-surface-settings.ts"],
    privateCacheRequired: true,
    supportSafe: true,
  },
  {
  ...
  },
  {
    ...
    requiredProofs: ["src/lib/operational-contracts.ts", "src/app/(dashboard)/settings/health/page.tsx"],
    privateCacheRequired: true,
    supportSafe: true,
  },
  {
    ...
    requiredProofs: ["src/lib/operational-contracts.ts", "src/lib/release-evidence.ts"],
    privateCacheRequired: true,
    supportSafe: true,
  },
  {
    domain: "billing_boundary",
    primaryRoute: "/settings/billing",
...
export const V10_ROUTE_PERFORMANCE_SMOKE_CONTRACTS: readonly V10RoutePerformanceSmokeContract[] = [
  {
    ...
    route: "/dashboard",
    proofArtifact: "e2e/current-product-core-smoke.spec.ts",
...
export function getV10RouteTestArtifact(path: string): string {
  ...
  if (runtimeArtifact.endsWith("/page.tsx")) {
    return "e2e/current-product-core-smoke.spec.ts";
  }
  if (path === "/api/command-palette/contracts") {
    return "src/app/api/command-palette/contracts/route.test.ts";
  }
...
export { buildV10RouteActionInventory as buildRouteActionInventory };
export { buildV10RouteApiInventory as buildRouteApiInventory };
export { getV10RouteContractsForSurface as getRouteContractsForSurface };
export { getV10RouteRuntimeArtifact as getRouteRuntimeArtifact };
export { getV10RouteTemplateForHref as getRouteTemplateForHref };
export { getV10RouteTestArtifact as getRouteTestArtifact };
export { resolveV10RoutePostContract as resolveRoutePostContract };
export { V10_ROUTE_API_CATALOG as ROUTE_API_CATALOG };
export { V10_ROUTE_PERFORMANCE_SMOKE_CONTRACTS as ROUTE_PERFORMANCE_SMOKE_CONTRACTS };
export { V10_ROUTER_JOBS_REPORTS_BOUNDARY_CONTRACTS as ROUTER_JOBS_REPORTS_BOUNDARY_CONTRACTS };
export { v10RouteRequiresPrivateCache as routeRequiresPrivateCache };
export { validateV10RouteActionInventory as validateRouteActionInventory };
export { validateV10RouteApiContract as validateRouteApiContract };
export { validateV10RouteApiInventory as validateRouteApiInventory };
export { validateV10RoutePerformanceSmokeContracts as validateRoutePerformanceSmokeContracts };
export { validateV10RouteResponseContract as validateRouteResponseContract };
export { validateV10RouterJobsReportsBoundaryContracts as validateRouterJobsReportsBoundaryContracts };
export type { V10HttpMethod as HttpMethod };
export type { V10RouteActionInventoryRow as RouteActionInventoryRow };
export type { V10RouteApiContract as RouteApiContract };
export type { V10RouteApiInventoryRow as RouteApiInventoryRow };
export type { V10RoutePerformanceSmokeContract as RoutePerformanceSmokeContract };
export type { V10RoutePostContractKind as RoutePostContractKind };
export type { V10RoutePostContractResolved as RoutePostContractResolved };
export type { V10RouterJobsReportsBoundaryContract as RouterJobsReportsBoundaryContract };
export type { V10RouterJobsReportsBoundaryDomain as RouterJobsReportsBoundaryDomain };
export type { V10RouteSurface as RouteSurface };

...
export const V10_IMPLEMENTATION_REQUIREMENTS: readonly V10ImplementationRequirement[] = [
  ...
  },
  {
    ...
    artifacts: [
      ...
      "src/lib/v10-read-model-refresh.ts",
      "src/actions/v10-bulk-compatible-work.ts",
  ...
  },
  {
    ...
    layer: "ui",
    artifacts: [
      "src/lib/v10-contract-health.ts",
      "src/lib/v10-read-model-refresh.ts",
  ...
  },
  {
    ...
    layer: "runtime_data",
    artifacts: [
      "src/lib/v10-field-provenance.ts",
      "src/lib/v10-read-model-refresh.ts",
      "src/actions/v4.ts",
    ],
    autonomous: true,
  },
  {
    ...
    layer: "runtime_data",
    artifacts: [
      "src/lib/v10-renewal-posture.ts",
      "src/lib/v10-read-model-refresh.ts",
  ...
  },
  {
    ...
    layer: "api",
    artifacts: [
      "src/lib/v10-evidence-collaboration.ts",
      "src/lib/v10-read-model-refresh.ts",
  ...
  },
  {
    ...
    layer: "mutation",
    artifacts: [
      "src/lib/v10-approval-exception.ts",
  ...
  },
  {
    ...
    layer: "test",
    artifacts: [
      "src/lib/v10-ui-state-contracts.ts",
  ...
  },
  {
    ...
    artifacts: [
      ...
      "src/lib/v10-read-model-refresh.ts",
      "src/lib/v10-advanced-assurance-continuity.ts",
    ],
    autonomous: true,
  },
  {
...
export const V10_ARTIFACT_CLASS_DEFINITIONS_OF_DONE: readonly V10ArtifactClassDefinitionOfDone[] = [
  {
    classKey: "schema",
    ownerArtifacts: ["supabase/migrations/057_v10_runtime_contracts.sql", "src/lib/v10-read-models.ts"],
    requiredProofs: ["migration", "backfill", "constraints", "indexes", "rls", "rollback_repair", "runtime_test"],
    releaseBlocker: true,
  },
  {
    classKey: "read_model",
    ownerArtifacts: ["src/lib/v10-read-models.ts", "src/lib/v10-read-model-refresh.ts"],
    requiredProofs: ["required_fields", "visibility", "freshness", "lineage", "repair", "fixture_states", "cross_org_negative"],
    releaseBlocker: true,
  },
  {
    classKey: "mutation",
    ownerArtifacts: ["src/lib/v10-mutation-envelope.ts", "src/lib/v10-server-contracts.ts"],
    requiredProofs: ["idempotency", "expected_version", "server_actor", "eligibility", "transactional_audit", "replay", "private_no_store"],
    releaseBlocker: true,
  },
  {
    classKey: "api_route",
    ownerArtifacts: ["src/app/api", "src/lib/v10-route-api-catalog.ts"],
  ...
  },
  {
    ...
    ownerArtifacts: ["src/actions", "src/lib/v10-server-contracts.ts"],
    requiredProofs: ["auth", "org_scope", "idempotency", "audit", "negative_test", "support_safe_error"],
    releaseBlocker: true,
  },
  {
    classKey: "ui_surface",
    ownerArtifacts: ["src/app/(dashboard)", "src/components", "src/components/ui/v10-recoverable-state.tsx"],
  ...
  {
    classKey: "job",
    ownerArtifacts: ["src/lib/v10-job-visibility.ts", "src/app/api/cron/v10"],
  ...
  },
  {
    ...
    ownerArtifacts: ["src/lib/product-telemetry.ts", "src/lib/v10-objective-telemetry.ts"],
    requiredProofs: ["owner", "allowed_fields", "redaction", "failure_handling", "objective_mapping", "release_evidence_link"],
    releaseBlocker: true,
  },
  {
    classKey: "test",
    ownerArtifacts: ["src/lib/*.v10.test.ts", "src/app/api/**/*.test.ts", "e2e/v10-core-smoke.spec.ts"],
  ...
  },
  {
    ...
    ownerArtifacts: ["src/lib/v10-release-evidence.ts", "scripts/check-v10-release-evidence.mjs"],
...
export function buildV10ArtifactDefinitionOfDone(
  ...
  return requirements.map((requirement) => {
    ...
    const routeOrAction = artifactMatches(requirement, [
      ...
      /^scripts\//,
      /^e2e\//,
      /v10-read-model-refresh/,
      /v10-route-api-catalog/,
      /v10-release-evidence/,
    ]) || runtimeBacked;
    const securityBacked = artifactMatches(requirement, [
      /v10-server-contracts/,
      /v10-mutation-envelope/,
      /v10-hardening-contracts/,
      /v10-governance/,
      /v10-route-api-catalog/,
      /^src\/app\//,
      /^src\/actions\//,
    ...
    const readModelBacked = artifactMatches(requirement, [
      /v10-read-model-refresh/,
      /v10-read-models/,
      /v10-activation-state/,
      /v10-job-visibility/,
      /v10-release-evidence/,
      /^src\/app\//,
    ]) || runtimeBacked;
    const releaseBacked = artifactMatches(requirement, [/v10-release-evidence/, /^scripts\/check-v10/, /^e2e\//]);
    const testBacked = artifactMatches(requirement, [/\.test\./, /^e2e\//, /v10-ui-state-contracts/, /v10-route-api-catalog/, /v10-hardening-contracts/, /v10-release-evidence/]);
    const telemetryBacked = artifactMatches(requirement, [/product-telemetry/, /v10-objective-telemetry/, /v10-release-evidence/, /^src\/app\//, /^src\/actions\//]) || runtimeBacked;
    ...
    return {
      ...
      mutationEnvelopeCovered:
        requirement.layer === "mutation" || requirement.layer === "api"
          ? artifactMatches(requirement, [/v10-mutation-envelope/, /v10-server-contracts/, /^src\/app\/api\//, /^src\/actions\//])
          : false,
      ...
      recoverabilityCovered: artifactMatches(requirement, [/v10-ui-state-contracts/, /v10-job-visibility/, /v10-read-model-refresh/, /^src\/app\//, /^e2e\//, /v10-release-evidence/]) || runtimeBacked,
      readModelFreshnessCovered: readModelBacked,
      privacyCovered: securityBacked || releaseBacked,
      accessibilityCovered: artifactMatches(requirement, [/v10-ui-state-contracts/, /^e2e\//, /^src\/app\//, /^src\/components\//, /v10-release-evidence/]) || runtimeBacked,
      performanceCovered: artifactMatches(requirement, [/v10-route-api-catalog/, /v10-ui-state-contracts/, /^src\/app\//, /^e2e\//, /v10-release-evidence/]) || runtimeBacked,
      ...
      fixtureCoverage:
        ...
        artifactMatches(requirement, [/v10-objective/, /v10-release-evidence/, /^e2e\//]),

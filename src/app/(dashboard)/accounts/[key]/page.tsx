  ...
  return (
    <div className="space-y-8">
      <header className="border-b border-zinc-200/60 pb-8">
        ...
        <p className="mt-2 text-sm text-zinc-500">Key: {workspace.account_key}</p>
        <Link href={`/api/accounts/${encodeURIComponent(key)}/summary`} className="ui-link mt-3 inline-block text-xs" target="_blank">
          Open summary JSON
        </Link>
      </header>

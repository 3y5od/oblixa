...
import { SupportDiagnosticCell, type DiagnosticTone } from "./settings-health-diagnostics-cells";
...
export type SettingsHealthDiagnosticsSectionsProps = {
...
export function SettingsHealthDiagnosticsSections(props: SettingsHealthDiagnosticsSectionsProps) {
  const {
    retryQueueDepth,
    pendingDeliveries,
    retryingDeliveries,

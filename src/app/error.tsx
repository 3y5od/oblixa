...
export default function RootError({
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center bg-canvas px-4 py-16 md:py-20">
      <div className="ui-card mx-auto max-w-md rounded-2xl border border-[var(--border-subtle)] px-6 py-8 text-center shadow-[var(--shadow-1)]">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link href="/login" className="ui-link px-2 py-2 text-sm font-semibold">
            Sign in
          </Link>
        </div>
      </div>

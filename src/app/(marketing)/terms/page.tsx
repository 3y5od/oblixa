      ...
      <MarketingLegalShell>
        <main id="main-content" tabIndex={-1} className="flex-1 outline-none">
          <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
            <h1 className="text-2xl font-semibold tracking-tight text-zinc-950 sm:text-3xl">Terms of use</h1>
            ...
            <div className="mt-8 max-w-none space-y-4 text-sm leading-relaxed text-zinc-700">
              ...
              <h2 className="mt-10 text-base font-semibold text-zinc-900">Acceptable use</h2>
              <p>
              ...
              <h2 className="mt-10 text-base font-semibold text-zinc-900">Accounts</h2>
              <p>
              ...
              <h2 className="mt-10 text-base font-semibold text-zinc-900">Disclaimers</h2>
              <p>
              ...
              <h2 className="mt-10 text-base font-semibold text-zinc-900">Service changes</h2>
              <p>
              ...
              <h2 className="mt-10 text-base font-semibold text-zinc-900">Governing law</h2>
              <p>

      ...
      <MarketingLegalShell>
        <main id="main-content" tabIndex={-1} className="flex-1 outline-none">
          <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
            <h1 className="text-2xl font-semibold tracking-tight text-[var(--text-primary)] sm:text-3xl">Privacy</h1>
            ...
            <div className="mt-8 max-w-none space-y-4 text-sm leading-relaxed text-[var(--text-secondary)]">
              ...
              <h2 className="mt-10 text-base font-semibold text-[var(--text-primary)]">What we process</h2>
              ...
              <h2 className="mt-10 text-base font-semibold text-[var(--text-primary)]">Why we process it</h2>
              <p>
              ...
              <h2 className="mt-10 text-base font-semibold text-[var(--text-primary)]">AI-assisted extraction</h2>
              <p>
              ...
              <h2 className="mt-10 text-base font-semibold text-[var(--text-primary)]">Retention</h2>
              <p>
              ...
              <h2 className="mt-10 text-base font-semibold text-[var(--text-primary)]">Your rights</h2>
              <p>
              ...
              <h2 className="mt-10 text-base font-semibold text-[var(--text-primary)]">Children</h2>
              <p>The service is not directed to children and is intended for business use.</p>
              <h2 className="mt-10 text-base font-semibold text-[var(--text-primary)]">Contact</h2>
              <p>

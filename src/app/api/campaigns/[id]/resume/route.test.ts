...
describe("POST /api/campaigns/[id]/resume", () => {
  ...
  it("returns duplicate response before resuming a campaign", async () => {
    ...
    const res = await POST(
      new Request("http://localhost/api/campaigns/c1/resume", {
        method: "POST",
        headers: { "x-idempotency-key": "campaign-resume-replay-0001" },
      }),

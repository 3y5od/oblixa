...
describe("POST /api/program-evolution/experiments/[id]/simulate", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("returns duplicate response before simulating an experiment", async () => {
    ...
    const { POST } = await import("@/app/api/program-evolution/experiments/[id]/simulate/route");
    const res = await POST(
      new Request("http://localhost/api/program-evolution/experiments/e1/simulate", {
        method: "POST",
        headers: {
          "content-type": "application/json",
          "x-idempotency-key": "experiment-simulate-replay-0001",
        },
        body: JSON.stringify({}),
      }),

 ...
 */
// skip-meta-default: owner=@test-governance expiry=2027-12-31 reason=a11y_extra_opt_in
...
test.describe("a11y nightly extra routes @epic10", () => {
  test.skip(!enabled, "Set A11Y_NIGHTLY_EXTRA_ROUTES=1 to expand axe matrix.");

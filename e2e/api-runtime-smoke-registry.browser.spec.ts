 ...
 */
// skip-meta-default: owner=@test-governance expiry=2027-12-31 reason=registry_smoke_opt_in_env
...
test.describe("api-runtime-smoke registry browser probes @epic7", () => {
  test.skip(!enabled, "Set PLAYWRIGHT_API_SMOKE_REGISTRY=1 to run registry-driven HTTP probes.");

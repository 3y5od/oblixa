...
// skip-meta-default: owner=@test-governance expiry=2026-12-31 reason=v5_surface_smokes_are_fixture_gated
...
test.describe("V5 external page", () => {
...
test.describe("V5 surfaces", () => {
  test.skip(
    !E2E_EMAIL || !E2E_PASSWORD,
    "Set E2E_TEST_EMAIL and E2E_TEST_PASSWORD to run authenticated V5 checks."
  );

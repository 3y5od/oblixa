...
export const GENERATED_ARTIFACT_HYGIENE_PATHS = [
  ...
  "artifacts/release-state-implementation-objectives.json",
...
export const GENERATED_ARTIFACT_WRITE_COMMANDS = {
  ...
  "artifacts/release-state-implementation-objectives.json": "npm run write:release-state-implementation-objectives",

...
function collectAutonomousCoverageBlockers(blockers) {
  let planTodoId = null;
  for (const line of read("src/lib/autonomous-coverage.ts")) {
...
function collectAcceptanceBlockers(blockers) {
  let id = null;
  for (const line of read("src/lib/acceptance-matrix.ts")) {
...
function collectReleaseEvidenceBlockers(blockers) {
  ...
  for (const line of read("src/lib/release-evidence.ts")) {

 ...
 * eligibility helpers nearby. Tune via scripts/compatibility-href-audit-allowlist.txt (glob, exact path, or
...
const ALLOWLIST_FILE = join(ROOT, "scripts", "compatibility-href-audit-allowlist.txt");

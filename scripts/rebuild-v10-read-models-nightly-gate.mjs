 ...
 * Plan: optional nightly rebuild:v10-read-models when V10_MIGRATION_SMOKE_* set.
 */
...
const r = spawnSync("npm", ["run", "rebuild:v10-read-models", "--", "--dry-run", "--scope=repair", "--limit=5"], {
  stdio: "inherit",
  shell: true,
  env: { ...process.env },
});

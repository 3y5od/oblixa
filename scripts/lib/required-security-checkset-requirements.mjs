export const REQUIRED_SECURITY_CHECK_SCRIPTS = [
  ...
  "check:security-external-obligations",
...
export const CI_REQUIRED_COMMANDS = [
  ...
  "npm run check:third-party-script-integrity",
  "npm run check:beacon-timing-leakage",
  ...
  "npm run check:security-external-obligations",
...
export const RELEASE_GATE_QUALITY_TAIL = ["lint", "typecheck", "test"];
